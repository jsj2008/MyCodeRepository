...
// Notifications
#define ITPHOTO_LOADING_DID_END_NOTIFICATION @"ITPHOTO_LOADING_DID_END_NOTIFICATION"
#define ITPHOTO_PROGRESS_NOTIFICATION @"ITPHOTO_PROGRESS_NOTIFICATION"

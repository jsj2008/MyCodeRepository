...
- (void)reloadDataBy:(NSDictionary *)dictionary {
    
    [self initMADataArray:dictionary];
    
    NSDictionary *rsiDic    = [dictionary objectForKey:[@(rsi) stringValue]];
    ...
    NSDictionary *kdjDic    = [dictionary objectForKey:[@(kdj) stringValue]];
    ...
    NSDictionary *macdDic   = [dictionary objectForKey:[@(macd) stringValue]];
...
//    self.macdDemLineColor   = [macdDic objectForKey:macdDemLineColorKey];
    ...
    NSDictionary *bollingerBandDic  = [dictionary objectForKey:[@(bollinger_band) stringValue]];

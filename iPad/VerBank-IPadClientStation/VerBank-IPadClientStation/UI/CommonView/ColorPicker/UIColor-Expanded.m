...
+ (UIColor *)randomColor {
	return [UIColor colorWithRed:(CGFloat)((double)arc4random() / ARC4RANDOM_MAX)
						   green:(CGFloat)((double)arc4random() / ARC4RANDOM_MAX)
							blue:(CGFloat)((double)arc4random() / ARC4RANDOM_MAX)
						   alpha:1.0f];
}

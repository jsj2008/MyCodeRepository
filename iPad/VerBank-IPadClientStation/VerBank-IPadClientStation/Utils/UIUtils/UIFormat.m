...
+ (UIImage *)getComplexGrayImageView {
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(200.0f, 200.0f), NO, 0);
    ...
    UIBezierPath *roundedRectanglePath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(0, 0, 200.0f, 200.0f) cornerRadius:0.0f];
    CGContextSaveGState(context);
    [roundedRectanglePath fill];
    [roundedRectanglePath addClip];
    CGContextDrawLinearGradient(context, gradient, CGPointMake(0, 0), CGPointMake(0, 200.0f), 0);
    CGColorSpaceRelease(colorSpace);
    CGGradientRelease(gradient);

...
- (void)initComponent {
    ...
    stateIndicator.image = [UIImage imageNamed:@"images/loadingImages/RefeshView_arrow.png"];
...
//    [_textIndicator setTextColor:[UIColor whiteColor]];
...
- (void)layoutSubviews {
    ...
    _activityIndicatorView.center = CGPointMake(SDActivityIndicatorViewMargin, self.refreshViewHeight * 0.5);
    _stateIndicatorView.center = _activityIndicatorView.center;
    
    _textIndicator.center = CGPointMake(self.refreshViewWidth * 0.5, self.refreshViewHeight * 0.5);
//    _timeIndicator.center = CGPointMake(self.refreshViewWidth * 0.5, self.refreshViewHeight - _timeIndicator.refreshViewHeight * 0.5 - SDTimeIndicatorMargin);
}
...
//            _textIndicator.text = SDRefreshViewRefreshingStateText;
            _textIndicator.text = [[LangCaptain getInstance] getLangByCode:@"Refreshing"];
...
//            _textIndicator.text = SDRefreshViewWillRefreshStateText;
             _textIndicator.text = [[LangCaptain getInstance] getLangByCode:@"RefreshRightNow"];

...
@interface MACDContentView()<AbstractTiContent> {
...
- (void)initContentView {
    ...
    [UIFormat initButtonStyle:_macdDiffLineColorButton];
    [UIFormat initButtonStyle:_macdDemLineColorButton];
    [UIFormat initButtonStyle:_macdPositiveColorButton];
    [UIFormat initButtonStyle:_macdNegativeColorButton];
...
- (void)checkInit {
    int defaultMacdShortPeriodValue = [[[TiArgumentConfig getInstance] macdShortPeriod] intValue];
    ...
    int defaultMacdLongPeriodValue = [[[TiArgumentConfig getInstance] macdLongPeriod] intValue];
    ...
    int defaultMacdPeriodSignalValue = [[[TiArgumentConfig getInstance] macdPeriodSignal] intValue];
    ...
    int defaultMacdDiffLineWidthValue = [[[TiArgumentConfig getInstance] macdDiffLineWidth] intValue];
    ...
    UIColor *defaultMacdDiffLineColorValue = [[TiArgumentConfig getInstance] macdDiffLineColor];
    [_macdDiffLineColorButton setBackgroundColor:defaultMacdDiffLineColorValue];
    
    int defaultMacdDemLineWidthValue = [[[TiArgumentConfig getInstance] macdDemLineWidth] intValue];
    ...
    UIColor *defaultMacdDemLineColorValue = [[TiArgumentConfig getInstance] macdDemLineColor];
    [_macdDemLineColorButton setBackgroundColor:defaultMacdDemLineColorValue];
    
    UIColor *defaultMacdPositiveColorValue = [[TiArgumentConfig getInstance] macdPositiveColor];
    [_macdPositiveColorButton setBackgroundColor:defaultMacdPositiveColorValue];
    
    UIColor *defaultMacdNegativeColorValue = [[TiArgumentConfig getInstance] macdNegativeColor];
...
- (void)commitTiArgument {
    [[TiArgumentConfig getInstance] setMacdShortPeriod:[[NSNumber alloc] initWithInt:_macdShortPeriodSlider.value]];
    [[TiArgumentConfig getInstance] setMacdLongPeriod:[[NSNumber alloc] initWithInt:_macdLongPeriodSlider.value]];
    [[TiArgumentConfig getInstance] setMacdPeriodSignal:[[NSNumber alloc] initWithInt:_macdPeriodSignalSlider.value]];
    [[TiArgumentConfig getInstance] setMacdDiffLineWidth:[[NSNumber alloc] initWithInt:_macdDiffLineWidthSlider.value]];
    [[TiArgumentConfig getInstance] setMacdDiffLineColor:_macdDiffLineColorButton.backgroundColor];
    [[TiArgumentConfig getInstance] setMacdDemLineWidth:[[NSNumber alloc] initWithInt:_macdDemLineWidthSlider.value]];
    [[TiArgumentConfig getInstance] setMacdDemLineColor:_macdDemLineColorButton.backgroundColor];
    [[TiArgumentConfig getInstance] setMacdPositiveColor:_macdPositiveColorButton.backgroundColor];
    [[TiArgumentConfig getInstance] setMacdNegativeColor:_macdNegativeColorButton.backgroundColor];

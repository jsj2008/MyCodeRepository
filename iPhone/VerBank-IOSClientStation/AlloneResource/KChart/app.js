...
(function (CscApi) {
    ...
    (function (ViewAlignReferenceBasis) {
        ViewAlignReferenceBasis[ViewAlignReferenceBasis["COORD"] = 0] = "COORD";
        ViewAlignReferenceBasis[ViewAlignReferenceBasis["TICK_INDEX"] = 1] = "TICK_INDEX";
    })(CscApi.ViewAlignReferenceBasis || (CscApi.ViewAlignReferenceBasis = {}));
    var ViewAlignReferenceBasis = CscApi.ViewAlignReferenceBasis;
    (function (FocusElementValueDisplayMode) {
        FocusElementValueDisplayMode[FocusElementValueDisplayMode["NONE"] = 0] = "NONE";
        FocusElementValueDisplayMode[FocusElementValueDisplayMode["ORDERING"] = 1] = "ORDERING";
        FocusElementValueDisplayMode[FocusElementValueDisplayMode["SORT_BY_ARGUMENTS_ASC"] = 2] = "SORT_BY_ARGUMENTS_ASC";
        FocusElementValueDisplayMode[FocusElementValueDisplayMode["SORT_BY_ARGUMENTS_DESC"] = 3] = "SORT_BY_ARGUMENTS_DESC";
    })(CscApi.FocusElementValueDisplayMode || (CscApi.FocusElementValueDisplayMode = {}));
    var FocusElementValueDisplayMode = CscApi.FocusElementValueDisplayMode;
    var TickData = (function () {
        function TickData() {
            this.primitives = new Float64Array(5);
            this.datetime = null;
        }
...
(function (CscImpl) {
    var Chart = (function () {
        ...
        Chart.prototype.getValueInfoVisible = function () {
            return this.infoVisible;
        };
        Chart.prototype.setValueInfoVisible = function (visible) {
        ...
        Chart.prototype.refContext = function () {
            return this.refCandlestickChart().getContextById(this.sourceContextId);
        };
        ...
        Chart.prototype.getOrderedTicksList = function () {
            var context = this.refContext();
            return context != null ? context.getOrderedTickList() : [];
        };
        ...
        Chart.prototype.getSourceContextId = function () {
            return this.sourceContextId;
        };
        Chart.prototype.setSourceContextId = function (contextId) {
        ...
        Chart.prototype.getHoveredDrawerId = function (xInArea, yInArea) {
            var drawers = this.drawers;
            for (var handleId in drawers) {
                var drawer = drawers[handleId];
                if (drawer.isCompleted()) {
                    if (drawer.isHover(xInArea, yInArea)) {
                        return handleId;
                    }
                }
            }
        ...
        Chart.prototype.drawYScaleValue = function (caption, yCoord) {
            var renderer = this.refRenderer();
            var area = this.getArea();
            var candlestickChart = area.getCandlestickChart();
            ...
            if (yCoord < 0) {
                ...
                if (yCoord + backRectHeight > this.height) {
                    yCoord = this.height - backRectHeight;
                }
            }
            var str = prefix + caption;
            var valueStrWidth = renderer.getTextWidth(str) + valueScaleFontSize;
            var xCoord = this.width;
            ...
            renderer.fillText(str, Math.floor(xCoord - valueStrWidth * 0.5), yCoord);
        };
        Chart.prototype.drawValueInfo = function (valueInfoList) {
            ...
            var shortMargin = Math.floor(styleFontSize * 0.309);
...
(function (CscImpl) {
    ...
    var ChartOfPsy = (function (_super) {
        ...
        ChartOfPsy.prototype.setConfig = function (config) {
            ...
            this.argPsyPeriod = Number(configPsyPeriod.value);
            this.argPsyMaPeriod = Number(configPsyMaPeriod.value);
            this.stylePsyLineWidth = Number(configPsyLineWidth.value);
            this.stylePsyLineColorRgba = configPsyLineColorRgba.value;
            this.stylePsyMaLineWidth = Number(configPsyMaLineWidth.value);
        ...
        ChartOfPsy.prototype.updateElements = function (updateTickFromIndex) {
            ...
            var orderedTickList = this.getOrderedTicksList();
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                if (closePrice > openPrice) {
                    ++nRaising;
                    periodRisingList.push(true);
                }
                else {
                    periodRisingList.push(false);
                }
                ++numberOfCounted;
            }
        };
...
(function (CscImpl) {
    var Style = (function () {
        function Style() {
            ...
            var numberOfSpanTypes = spanTypeList.length;
            for (var i = 0; i < numberOfSpanTypes; ++i) {
...
(function (CscImpl) {
    ...
    var ChartOfCci = (function (_super) {
        ...
        ChartOfCci.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleCciLineWidth = Number(configCciLineWidth.value);
        ...
        ChartOfCci.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                var highPrice = tickData.getHigh();
                var lowPrice = tickData.getLow();
                var closePrice = tickData.getClose();
                if (isNaN(highPrice) || isNaN(lowPrice) || isNaN(closePrice)) {
                    elementTpList[i] = NaN;
                    elementCciList[i] = NaN;
                    continue;
                }
                var tp = elementTpList[i] = (highPrice + lowPrice + closePrice) / 3;
                sumTp += tp;
                periodIndexList.push(i);
                if (numberOfCounted >= period) {
                    var deductedIndex = periodIndexList.shift();
                    sumTp -= elementTpList[deductedIndex];
                    var tpAvg = sumTp / period;
                    var sumDiff = 0;
                    for (var n = 0; n < period; ++n) {
                        var index = periodIndexList[n];
                        sumDiff += Math.abs(elementTpList[index] - tpAvg);
                    }
...
(function (CscImpl) {
    ...
    var Drawer = (function () {
        ...
        Drawer.prototype.refContext = function () {
            return this.refCandlestickChart().getContextById(this.chart.getSourceContextId());
        };
        ...
        Drawer.prototype.setColor = function (colorRgba) {
        };
        ...
        Drawer.prototype.move = function (xInArea, yInArea) {
            ...
            var candlestickChart = this.refCandlestickChart();
            var tickIndex = candlestickChart.getTickIndexFromXInArea(area.getHandleId(), xInArea);
            var context = this.refContext();
        ...
        Drawer.prototype.isHover = function (xInArea, yInArea) {
            return false;
        };
...
(function (CscImpl) {
    var DrawerOfLine = (function (_super) {
        ...
        function DrawerOfLine(chart, handleId) {
            ...
            this.pathOfLine1 = CscApi.createStrokePath();
        }
        ...
        DrawerOfLine.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
        };
        DrawerOfLine.prototype.getStyleLine1Width = function () {
            return this.styleLine1Width;
        };
        DrawerOfLine.prototype.setStyleLine1Width = function (lineWidth) {
        ...
        DrawerOfLine.prototype.setStyleLine1DashedLength = function (dashedLength) {
            ...
            this.config.params['lineDashedLength'].value = dashedLength;
        };
        ...
        DrawerOfLine.prototype.render = function () {
            ...
            if (line1 != null) {
                ...
                var pathOfLine1 = this.pathOfLine1;
                pathOfLine1.setPathAsLine(line1.getX1(), line1.getY1(), line1.getX2(), line1.getY2(), 5);
            }
        };
        DrawerOfLine.prototype.isHover = function (xInArea, yInArea) {
            var pathOfLine1 = this.pathOfLine1;
            return pathOfLine1.isPointInPath(xInArea, yInArea);
        };
        return DrawerOfLine;
    }(CscImpl.Drawer));
...
(function (CscImpl) {
    var DrawerOfGoldenCircle = (function (_super) {
        ...
        function DrawerOfGoldenCircle(chart, handleId) {
            ...
            this.pathOfLine = CscApi.createStrokePath();
            this.pathOfCircle = CscApi.createStrokePath();
            this.pathOfFan = CscApi.createStrokePath();
            this.pathOfGoldenArc = CscApi.createStrokePath();
        }
        ...
        DrawerOfGoldenCircle.prototype.setColor = function (colorRgba) {
            this.setStyleCircleLineColorRgba(colorRgba);
            this.setStyleFanLineColorRgba(colorRgba);
            this.setStyleGoldenArcLineColorRgba(colorRgba);
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleCircleLineWidth = function (lineWidth) {
            ...
            this.config.params['circleLineWidth'].value = lineWidth;
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleCircleLineDashedLength = function (dashedLength) {
            ...
            this.config.params['circleLineDashedLength'].value = dashedLength;
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleCircleLineColorRgba = function (colorRgba) {
            ...
            this.config.params['circleLineColorRgba'].value = colorRgba;
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleFanLineWidth = function (lineWidth) {
            ...
            this.config.params['fanLineWidth'].value = lineWidth;
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleFanLineDashedLength = function (dashedLength) {
            ...
            this.config.params['fanLineDashedLength'].value = dashedLength;
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleFanLineColorRgba = function (colorRgba) {
            ...
            this.config.params['fanLineColorRgba'].value = colorRgba;
        };
        ...
        DrawerOfGoldenCircle.prototype.setStyleGoldenArcLineWidth = function (lineWidth) {
            ...
            this.config.params['goldenArcLineWidth'].value = lineWidth;
        };
        DrawerOfGoldenCircle.prototype.getStyleGoldenArcLineDashedLength = function () {
            return this.styleGoldenArcLineDashedLength;
        };
        DrawerOfGoldenCircle.prototype.setStyleGoldenArcLineDashedLength = function (dashedLength) {
            this.styleGoldenArcLineDashedLength = dashedLength;
            this.config.params['goldenArcLineDashedLength'].value = dashedLength;
        };
        DrawerOfGoldenCircle.prototype.getStyleGoldenArcLineColorRgba = function () {
            return this.styleGoldenArcLineColorRgba;
        };
        DrawerOfGoldenCircle.prototype.setStyleGoldenArcLineColorRgba = function (colorRgba) {
            ...
            this.config.params['goldenArcLineColorRgba'].value = colorRgba;
        };
        DrawerOfGoldenCircle.prototype.render = function () {
            ...
            if (radius > 0) {
                ...
                var circleStartAngle = angleInRad + arcHalfAngle;
                var circleEndAngle = angleInRad - arcHalfAngle;
                renderer.setLineWidth(this.styleCircleLineWidth);
                renderer.setStrokeColorRgba(this.styleCircleLineColorRgba);
                renderer.strokeDashedArc(this.styleCircleLineDashedLength, x1, y1, radius, circleStartAngle, circleEndAngle);
                this.pathOfCircle.setPathAsArc(x1, y1, radius, circleStartAngle, circleEndAngle, 5);
                var fanStartAngle = angleInRad - arcHalfAngle;
                var fanEndAngle = angleInRad + arcHalfAngle;
                renderer.setLineWidth(this.styleFanLineWidth);
                renderer.setStrokeColorRgba(this.styleFanLineColorRgba);
                renderer.strokeDashedFan(this.styleFanLineDashedLength, x1, y1, radius, fanStartAngle, fanEndAngle);
                this.pathOfFan.setPathAsFan(x1, y1, radius, fanStartAngle, fanEndAngle, 5);
                renderer.strokeDashedLine(this.styleFanLineDashedLength, x1, y1, x2, y2);
                this.pathOfLine.setPathAsLine(x1, y1, x2, y2, 5);
                var goldenArcStartAngle = angleInRad - arcHalfAngle;
                var goldenArcEndAngle = angleInRad + arcHalfAngle;
                renderer.setLineWidth(this.styleGoldenArcLineWidth);
                renderer.setStrokeColorRgba(this.styleGoldenArcLineColorRgba);
                renderer.strokeDashedArc(this.styleCircleLineDashedLength, x1, y1, radius * 0.618, goldenArcEndAngle, goldenArcStartAngle);
                renderer.strokeDashedArc(this.styleGoldenArcLineDashedLength, x1, y1, radius * 0.618, goldenArcStartAngle, goldenArcEndAngle);
                this.pathOfGoldenArc.setPathAsArc(x1, y1, radius * 0.618, 0, Math.PI * 2, 5);
            }
        };
        DrawerOfGoldenCircle.prototype.isHover = function (xInArea, yInArea) {
            return (this.pathOfLine.isPointInPath(xInArea, yInArea) ||
                this.pathOfCircle.isPointInPath(xInArea, yInArea) ||
                this.pathOfGoldenArc.isPointInPath(xInArea, yInArea) ||
                this.pathOfFan.isPointInPath(xInArea, yInArea));
        };
...
(function (CscImpl) {
    ...
    var ChartOfRoc = (function (_super) {
        ...
        ChartOfRoc.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleRocLineWidth = Number(configRocLineWidth.value);
        ...
        ChartOfRoc.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                periodPriceList.push(closePrice);
                if (numberOfCounted >= period) {
                    var periodClosePrice = periodPriceList.shift();
                    elementRocList[i] = (closePrice - periodClosePrice) / periodClosePrice;
                }
                else {
                    elementRocList[i] = NaN;
                }
...
(function (CscImpl) {
    ...
    var ChartOfMa = (function (_super) {
        ...
        ChartOfMa.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleMaLineWidth = Number(configMaLineWidth.value);
        ...
        ChartOfMa.prototype.updateElements = function (updateTickFromIndex) {
            ...
            if (this.elementViewMaDragon == null || this.elementViewMaDragon.length !== numberOfDragonComponents) {
                this.elementViewMaDragon = CscApi.Utility.resizeFloat32Array(this.elementViewMaDragon, numberOfDragonComponents, NaN);
            }
            if (this.elementMaList == null || this.elementMaList.length != numberOfOrderedTickList) {
                this.elementMaList = CscApi.Utility.resizeFloat32Array(this.elementMaList, numberOfOrderedTickList, NaN);
            }
            var elementMaList = this.elementMaList;
            var period = this.argPeriod;
            var periodSum = 0;
            var startIndex = Math.max(updateTickFromIndex - period, 0);
            var periodSumPriceList = [];
            var numberOfCounted = 0;
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                var closePrice = tickData.getClose();
                ...
                if (numberOfCounted < period) {
                    ...
                    var deductedClosePrice = periodSumPriceList.shift();
                    periodSum -= deductedClosePrice;
                }
                periodSum += closePrice;
                periodSumPriceList.push(closePrice);
                ++numberOfCounted;
            }
        };
        ChartOfMa.prototype.updateViewYRange = function (viewStartTickIndex, viewEndTickIndex) {
            var elementMaList = this.elementMaList;
            if (elementMaList == null) {
                console.error('elementMaList is null.');
                return {
                    lowestValue: 0,
                    highestValue: 0,
                };
        ...
        ChartOfMa.prototype.updateForRendering = function (viewStartTickIndex, viewEndTickIndex, areaLowestValue, areaHighestValue, pixelsPerValue, valueToYCoordConvertor, yAxisEnabled) {
            ...
            for (var i = viewStartTickIndex; i <= viewEndTickIndex; ++i) {
                ...
                var vi = i * 2;
                if (isNaN(ma)) {
                    elementViewMaDragon[vi] = NaN;
                    elementViewMaDragon[vi + 1] = NaN;
                }
                else {
                    elementViewMaDragon[vi] = timeScaleElement.viewXCoord;
                    elementViewMaDragon[vi + 1] = (ma >= 0 ? Math.floor(valueToYCoordConvertor(ma)) : NaN);
                }
            }
...
(function (CscImpl) {
    var DrawerOfLinearRegression = (function (_super) {
        ...
        DrawerOfLinearRegression.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
        };
        ...
        DrawerOfLinearRegression.prototype.render = function () {
            ...
            if (firstIndex != null && lastIndex != null) {
                ...
                if (lastIndex >= numberOfTicks) {
                    lastIndex = numberOfTicks - 1;
                }
                var sumX = 0;
                var sumY = 0;
                var sumXy = 0;
                ...
                var pathOfLine1 = this.pathOfLine1;
                pathOfLine1.setPathAsLine(linearRegressionLine.getX1(), linearRegressionLine.getY1(), linearRegressionLine.getX2(), linearRegressionLine.getY2(), 5);
            }
        };
        DrawerOfLinearRegression.prototype.isHover = function (xInArea, yInArea) {
            var pathOfLine1 = this.pathOfLine1;
            return pathOfLine1.isPointInPath(xInArea, yInArea);
        };
...
(function (CscImpl) {
    ...
    var ChartOfKdj = (function (_super) {
        ...
        ChartOfKdj.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleKLineWidth = Number(configKLineWidth.value);
            this.styleKLineColorRgba = configKLineColorRgba.value;
            this.styleDLineWidth = Number(configDLineWidth.value);
            this.styleDLineColorRgba = configDLineColorRgba.value;
            this.styleJLineWidth = Number(configJLineWidth.value);
        ...
        ChartOfKdj.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                var closePrice = tickData.getClose();
                if (isNaN(closePrice)) {
                    elementKList[i] = elementDList[i] = elementJList[i] = NaN;
                    continue;
                }
                if (false == isNaN(pi)) {
                    if (numberOfCounted >= period) {
                        ...
                        for (var n = 0; n < period; ++n) {
                            var idx = periodIndexList[n];
                            var td = orderedTickList[idx];
                            var low = td.getLow();
                            var high = td.getHigh();
                            if (low < periodLow) {
                                periodLow = low;
                        ...
                        var rsv = periodHigh === periodLow ? 100 :
                            closePrice === periodLow ? 1 :
                                100 * (closePrice - periodLow) / (periodHigh - periodLow);
...
(function (CscImpl) {
    ...
    var ChartOfRsi = (function (_super) {
        ...
        ChartOfRsi.prototype.setConfig = function (config) {
            ...
            this.argShortPeriod = Number(configShortPeriod.value);
            this.argLongPeriod = Number(configLongPeriod.value);
            this.styleRsiShortLineWidth = Number(configRsiShortLineWidth.value);
            this.styleRsiShortLineColorRgba = configRsiShortLineColorRgba.value;
            this.styleRsiLongLineWidth = Number(configRsiLongLineWidth.value);
        ...
        ChartOfRsi.prototype.updateElements = function (updateTickFromIndex) {
            ...
            var shortPeriodRisingList = [];
            var shortPeriodFallingList = [];
            var longPeriodRisingList = [];
            var longPeriodFallingList = [];
            var numberOfCounted = 0;
            var pi = NaN;
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                ...
                if (isNaN(pi)) {
                    elementShortList[i] = elementLongList[i] = NaN;
                    pi = i;
                    continue;
                }
                var prevTickData = orderedTickList[pi];
                var prevClosePrice = prevTickData.getClose();
                var diff = closePrice - prevClosePrice;
                ...
                shortPeriodRisingList.push(diffRising);
                shortPeriodFallingList.push(diffFalling);
                longPeriodRisingList.push(diffRising);
                longPeriodFallingList.push(diffFalling);
                if (numberOfCounted >= shortPeriod) {
                    sumRisingShort -= shortPeriodRisingList.shift();
                    sumFallingShort -= shortPeriodFallingList.shift();
                    if (numberOfCounted >= longPeriod) {
                        sumRisingLong -= longPeriodRisingList.shift();
                        sumFallingLong -= longPeriodFallingList.shift();
                    }
                }
                var pShort = numberOfCounted < shortPeriod ? numberOfCounted + 1 : shortPeriod;
                var pLong = numberOfCounted < longPeriod ? numberOfCounted + 1 : longPeriod;
...
(function (CscImpl) {
    var Context = (function () {
        function Context(tickLocalTimeOffsetMsec) {
            if (tickLocalTimeOffsetMsec == null) {
                throw 'Context must have argument of tick local time offset.';
            }
            this.ticks = new CscApi.OrderedHashMap();
            this.orderedTickList = [];
            this.snGeneratorOfEvents = new CscApi.SnGenerator();
            this.eventsOfTickUpdated = {};
            this.eventsOfTickRemoved = {};
            this.tickLocalTimeOffsetMsec = tickLocalTimeOffsetMsec;
        }
        ...
        Context.prototype.getTickLocalTimeOffsetMsec = function () {
            return this.tickLocalTimeOffsetMsec;
        };
        Context.prototype.clearTicks = function () {
            this.ticks.Clear();
            this.orderedTickList = [];
            this.orderedTickListIsDirty = false;
            this.fireEventForOnTickRemoved(0, null, null);
        };
        ...
        Context.prototype.addTicks = function (tickList) {
            ...
            for (var i = 0; i < numberOfTick; ++i) {
                ...
                if (tick != null) {
                    ...
                    var modifiedIndex = ticks.PutAndCheckIndex(tickTime, tickData);
                    if (modifiedIndex != null) {
                        if (modifiedIndex < modifiedLowerestIndex) {
                            modifiedLowerestIndex = modifiedIndex;
                        }
                        addedKeyList.push(tickTime);
                        addedValueList.push(tickData);
                    }
                }
            }
            this.orderedTickListIsDirty = true;
            if (isFinite(modifiedLowerestIndex)) {
                this.fireEventForOnTickUpdated(modifiedLowerestIndex, null, null, addedKeyList, addedValueList);
            }
            return true;
        };
        ...
        Context.prototype.emplaceTicksIfNotExisting = function (tickList, mergeTimeSpanInMsec) {
            return this.updateTicks(tickList, mergeTimeSpanInMsec, null);
        };
        Context.prototype.updateTicks = function (tickList, mergeTimeSpanInMsec, isMerged) {
            if (mergeTimeSpanInMsec == null) {
                mergeTimeSpanInMsec = 1;
            }
            else if (mergeTimeSpanInMsec <= 0) {
                console.error('invalid merge time, must be greater than zero.');
                return;
            }
            var tickLocalTimeOffsetMsec = this.tickLocalTimeOffsetMsec;
            var modifiedLowerestIndex = Infinity;
            var ticks = this.ticks;
            var numberOfTick = tickList.length;
            var changedKeyMap = {};
            var changedKeyList = [];
            var changedValueList = [];
            var addedKeyMap = {};
            var addedKeyList = [];
            var addedValueList = [];
            for (var i = 0; i < numberOfTick; ++i) {
                ...
                if (tick != null) {
                    ...
                    var tickTimeInTimezone = tickTime + tickLocalTimeOffsetMsec;
                    var locationTickTime = Math.floor(tickTimeInTimezone / mergeTimeSpanInMsec) * mergeTimeSpanInMsec;
                    tickData.setDatetime(new Date(locationTickTime));
                    var locationTickData = ticks.Get(locationTickTime);
                    if (locationTickData == null) {
                        var boundariesPoints = ticks.FindKeyBoundaryPointers(tickTimeInTimezone);
                        ...
                        if (numberOfBoundariesKeys > 0) {
                            ...
                            if (lowerBoundTickData) {
                                var lowerBoundLocationTickTime = Math.floor((lowerBoundTickData.getDatetime().getTime() + tickLocalTimeOffsetMsec) / mergeTimeSpanInMsec) * mergeTimeSpanInMsec;
                        ...
                        if (locationTickData == null && numberOfBoundariesKeys > 1) {
                            ...
                            if (upperBoundTickData) {
                                var upperBoundLocationTickTime = Math.floor((upperBoundTickData.getDatetime().getTime() + tickLocalTimeOffsetMsec) / mergeTimeSpanInMsec) * mergeTimeSpanInMsec;
                    ...
                    if (locationTickData) {
                        ...
                        if (changedKeyMap[locationTickTime] == null) {
                            changedKeyMap[locationTickTime] = true;
                            changedKeyList.push(locationTickTime);
                            changedValueList.push(locationTickData);
                        }
                    }
                    else {
                        modifiedIndex = ticks.PutAndCheckIndex(locationTickTime, tickData);
                        locationTickData = tickData;
                        if (addedKeyMap[locationTickTime] == null) {
                            addedKeyMap[locationTickTime] = true;
                            addedKeyList.push(locationTickTime);
                            addedValueList.push(tickData);
                        }
                    }
                    if (modifiedIndex != null) {
            ...
            this.orderedTickListIsDirty = true;
            if (isFinite(modifiedLowerestIndex)) {
                this.fireEventForOnTickUpdated(modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
            }
            return true;
        };
        ...
        Context.prototype.getUpperBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
        ...
        Context.prototype.getLowerBoundOrUpperBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
            var lowerBound = boundaries[0];
            if (lowerBound != null) {
                return lowerBound.index;
        ...
        Context.prototype.getUpperBoundOrLowerBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
            var upperBound = boundaries[1];
            if (upperBound != null) {
                return upperBound.index;
        ...
        Context.prototype.fireEventForOnTickUpdated = function (modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
            var eventCallbacks = this.eventsOfTickUpdated;
            for (var handleId in eventCallbacks) {
                var callback = eventCallbacks[handleId];
                if (callback) {
                    callback(modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
                }
            }
        };
        Context.prototype.fireEventForOnTickRemoved = function (modifiedLowerestIndex, changedKeyList, changedValueList) {
            var eventCallbacks = this.eventsOfTickRemoved;
            for (var handleId in eventCallbacks) {
                var callback = eventCallbacks[handleId];
                if (callback) {
                    callback(modifiedLowerestIndex, changedKeyList, changedValueList);
                }
            }
        };
        Context.prototype.addEventListenerOnTickUpdated = function (callback) {
            if (callback == null) {
                return null;
            }
            var handleId = this.snGeneratorOfEvents.allocate();
            this.eventsOfTickUpdated[handleId] = callback;
            return handleId;
        };
        Context.prototype.addEventListenerOnTickRemoved = function (callback) {
            if (callback == null) {
                return null;
            }
            var handleId = this.snGeneratorOfEvents.allocate();
            this.eventsOfTickRemoved[handleId] = callback;
            return handleId;
        };
        Context.prototype.removeEventListener = function (handleId) {
            ...
            delete this.eventsOfTickUpdated[handleId];
            delete this.eventsOfTickRemoved[handleId];
...
(function (CscImpl) {
    ...
    var CandlestickChart = (function () {
        function CandlestickChart(canvas, context) {
            var _this = this;
            this.canvas = canvas;
            this.contextAdapter = new CscImpl.ContextAdapter(this);
            this.contextAdapter.setContextTickUpdatedCallback(function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
                _this.onTickUpdate(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
            });
            this.contextAdapter.setContextTickRemovedCallback(function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList) {
                _this.onTickRemove(contextId, modifiedLowerestIndex, changedKeyList, changedValueList);
            });
            this.renderer = null;
            ...
            this.touchControlFocusLineDistanceThreshold = 15;
        ...
        CandlestickChart.prototype.getContextById = function (contextId) {
            return this.contextAdapter.getEvaluatedContext(contextId);
        };
        CandlestickChart.prototype.getBoundContext = function (contextId) {
            return this.contextAdapter.getBoundContext(contextId);
        };
        CandlestickChart.prototype.bindContext = function (contextId, context) {
            if (context == null) {
                return;
            }
            this.contextAdapter.bindContext(contextId, context);
            this.timeScale.setContext(this.contextAdapter.getEvaluatedContext(contextId));
            this.tickDataIsDirty = true;
            this.modifiedLowerestIndex = 0;
            this.update();
            this.onTickUpdate(null, 0, null, null, null, null);
            this.present();
        };
        CandlestickChart.prototype.unbindContext = function (contextId) {
            if (false == this.contextAdapter.unbindContext(contextId)) {
                return;
            }
            this.timeScale.setContext(this.contextAdapter.getEvaluatedContext(contextId));
            this.tickDataIsDirty = true;
        ...
        CandlestickChart.prototype.getPixelRatio = function () {
        ...
        CandlestickChart.prototype.getTickIndexFromX = function (x) {
            return this.timeScale.getTickIndexFromX(x);
        };
        CandlestickChart.prototype.getXFromTickIndex = function (index) {
            return this.timeScale.getXFromTickIndex(index);
        };
        ...
        CandlestickChart.prototype.setViewTickWidthAlignByLeftBaseOnTickIndex = function (tickWidth) {
            var halfTickWidth = tickWidth * 0.5;
            var viewStartXCoord = this.getViewStartXCoord();
            var leftestTickIndex = this.getTickIndexFromX(viewStartXCoord);
            this.setViewTickWidth(tickWidth);
            this.update();
            this.setViewStartXCoord(this.getXFromTickIndex(leftestTickIndex) + halfTickWidth);
            this.present();
        };
        CandlestickChart.prototype.setViewTickWidthAlignByRightBaseOnTickIndex = function (tickWidth) {
            var halfTickWidth = tickWidth * 0.5;
            var viewEndXCoord = this.getViewEndXCoord();
            var rightestTickIndex = this.getTickIndexFromX(viewEndXCoord);
            this.setViewTickWidth(tickWidth);
            this.update();
            this.setViewEndXCoord(this.getXFromTickIndex(rightestTickIndex) + halfTickWidth);
            this.present();
        };
        CandlestickChart.prototype.setViewTickWidthAlignByLeftBaseOnCoord = function (tickWidth) {
            var viewStartXCoord = this.getViewStartXCoord();
            var origTickWidth = this.getViewTickWidth();
            var xScale = tickWidth / origTickWidth;
            this.setViewTickWidth(tickWidth);
            this.update();
            this.setViewStartXCoord(viewStartXCoord * xScale);
            this.present();
        };
        CandlestickChart.prototype.setViewTickWidthAlignByRightBaseOnCoord = function (tickWidth) {
            var viewEndXCoord = this.getViewEndXCoord();
            var origTickWidth = this.getViewTickWidth();
            var xScale = tickWidth / origTickWidth;
            this.setViewTickWidth(tickWidth);
            this.update();
            this.setViewEndXCoord(viewEndXCoord * xScale);
            this.present();
        };
        CandlestickChart.prototype.setViewTickWidthWithViewAlign = function (tickWidth, viewAlignMode, viewAlignBasis) {
            switch (viewAlignMode) {
                case CscApi.ViewAlignMode.LEFT:
                    switch (viewAlignBasis) {
                        case CscApi.ViewAlignReferenceBasis.TICK_INDEX:
                            this.setViewTickWidthAlignByLeftBaseOnTickIndex(tickWidth);
                            break;
                        case CscApi.ViewAlignReferenceBasis.COORD:
                            this.setViewTickWidthAlignByLeftBaseOnCoord(tickWidth);
                            break;
                    }
                    break;
                case CscApi.ViewAlignMode.RIGHT:
                    switch (viewAlignBasis) {
                        case CscApi.ViewAlignReferenceBasis.TICK_INDEX:
                            this.setViewTickWidthAlignByRightBaseOnTickIndex(tickWidth);
                            break;
                        case CscApi.ViewAlignReferenceBasis.COORD:
                            this.setViewTickWidthAlignByRightBaseOnCoord(tickWidth);
                            break;
                    }
                    break;
                default:
        ...
        ;
        CandlestickChart.prototype.getViewXFromXInArea = function (areaHandleId, xInArea) {
            var areaContext = this.areaContexts[areaHandleId];
            if (areaContext != null) {
                var area = areaContext.area;
                if (area != null) {
                    return xInArea + area.getViewStartXCoord();
                }
            }
            return null;
        };
        CandlestickChart.prototype.getTickIndexFromXInArea = function (areaHandleId, xInArea) {
            ...
            if (areaContext != null) {
                var area = areaContext.area;
                if (area != null) {
                    return this.timeScale.getTickIndexFromX(xInArea + area.getViewStartXCoord());
                }
            }
            return null;
        };
        CandlestickChart.prototype.getXInAreaFromTickIndex = function (areaHandleId, index) {
            ...
            if (areaContext != null) {
                var area = areaContext.area;
                if (area != null) {
                    return Math.floor(this.timeScale.getXFromTickIndex(index) - area.getViewStartXCoord());
                }
            }
            return null;
        };
        ...
        CandlestickChart.prototype.update = function () {
            if (this.contextAdapter.getAnyEvaluatedContext() === undefined)
                debugger;
            this.timeScale.setContext(this.contextAdapter.getAnyEvaluatedContext());
        ...
        CandlestickChart.prototype.zoom = function (scale) {
            var origViewTickWidth = this.getViewTickWidth();
            var newViewTickWidth = origViewTickWidth * scale;
        ...
        CandlestickChart.prototype.getViewStartXCoord = function () {
            var xCoord = null;
            var areaContexts = this.areaContexts;
            for (var handleId in areaContexts) {
                var areaContext = areaContexts[handleId];
                var area = areaContext.area;
                var areaViewXCoord = area.getViewStartXCoord();
                if (xCoord === null || areaViewXCoord < xCoord) {
                    xCoord = areaViewXCoord;
                }
            }
            return xCoord;
        };
        ...
        CandlestickChart.prototype.getViewEndXCoord = function () {
            var xCoord = null;
            var areaContexts = this.areaContexts;
            for (var handleId in areaContexts) {
                var areaContext = areaContexts[handleId];
                var area = areaContext.area;
                var areaViewXCoord = area.getViewEndXCoord();
                if (areaViewXCoord > xCoord) {
                    xCoord = areaViewXCoord;
                }
            }
            return xCoord;
        };
        CandlestickChart.prototype.setViewEndXCoord = function (xCoord) {
            xCoord = Math.floor(xCoord);
            var areaContexts = this.areaContexts;
            for (var handleId in areaContexts) {
                var areaContext = areaContexts[handleId];
                var area = areaContext.area;
                area.setViewEndXCoord(xCoord);
            }
        };
        CandlestickChart.prototype.getTouchControlFocusLineDistanceThreshold = function () {
            return this.touchControlFocusLineDistanceThreshold;
        };
        CandlestickChart.prototype.setTouchControlFocusLineDistanceThreshold = function (distance) {
            this.touchControlFocusLineDistanceThreshold = distance;
        };
        ...
        CandlestickChart.prototype.processMouseEvent = function (button, state, eventType) {
            if (eventType === MouseEventType.UP) {
            ...
            var posY = state.GetPositionY();
            var areaContexts = this.areaContexts;
            var hoveredDrawerChartId = null;
            var cssCursorName = 'default';
            for (var handleId in areaContexts) {
                var areaContext = areaContexts[handleId];
                var area = areaContext.area;
                ...
                if (this.isHitArea(xInArea, yInArea, areaContext)) {
                    ...
                    if (hoveredDrawerChartId == null) {
                        hoveredDrawerChartId = area.getHoveredDrawerChartId(xInArea, yInArea);
                        if (hoveredDrawerChartId != null) {
            ...
            this.canvas.style.cursor = cssCursorName;
            this.present();
        };
        ...
        CandlestickChart.prototype.onTouchStart = function (state) {
            var x = state.GetPositionXList()[0];
            var y = state.GetPositionYList()[0];
            this.touchMoveTimeline = true;
            var distance = this.touchControlFocusLineDistanceThreshold;
            var areaContexts = this.areaContexts;
            for (var handleId in areaContexts) {
                var areaContext = areaContexts[handleId];
                var area = areaContext.area;
                ...
                var yInArea = y - areaY;
                if (this.isHitArea(xInArea, yInArea, areaContext)) {
                    if (area.isHitCoordFocusLineCenter(xInArea, yInArea, distance)) {
                        this.touchMoveTimeline = false;
                        break;
                    }
                }
            }
            this.prevDragStartX = x;
            this.prevDragStartY = y;
        ...
        CandlestickChart.prototype.onTickUpdate = function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
            this.tickDataIsDirty = true;
            ...
            var numberOfTimeScaleElements = timeScaleElements.length;
            var lastTickIndex = Math.max(numberOfTimeScaleElements - 1, 0);
            if (this.autoScrollEnabled) {
                if (timeScaleElements != null && addedKeyList != null) {
                    var numberOfNewTicks = addedKeyList.length;
                    if (numberOfNewTicks > 0) {
                        ...
                        for (var handleId in areaContexts) {
                            ...
                            var offsetCount = 0;
                            for (var n = 0; n < numberOfNewTicks; ++n) {
                                var tick = addedValueList[n];
                                var tickTime = tick.getDatetime().getTime();
                                var tickIndex = this.contextAdapter.getLowerBoundTickIndexByTime(tickTime);
                                if (tickIndex <= ei + 1) {
                                    ++offsetCount;
                                }
                            }
                            if (offsetCount > 0) {
                                area.setViewStartTickIndex(si + offsetCount);
                                area.setViewEndTickIndex(ei + offsetCount);
                            }
                        }
                    }
                }
            ...
            for (var handleId in areaContexts) {
                ...
                if (this.lockFocusElementToLast) {
                    area.setFocusElementIndex(numberOfTimeScaleElements - 1);
                }
                else {
                    var focusElementIndex = area.getFocusElementIndex();
                    if (numberOfTimeScaleElements <= 0 || focusElementIndex >= numberOfTimeScaleElements) {
                        if (numberOfTimeScaleElements <= 0) {
        ...
        CandlestickChart.prototype.onTickRemove = function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList) {
            this.onTickUpdate(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, null, null);
        };
        ...
        CandlestickChart.prototype.isHitArea = function (xInArea, yInArea, areaContext) {
            var area = areaContext.area;
            if (area != null) {
                if (xInArea >= 0 && xInArea <= area.getWidth() &&
                    yInArea >= 0 && yInArea <= area.getHeight()) {
                    return true;
                }
            }
            return false;
...
(function (CscImpl) {
    ...
    var ChartOfTimeScale = (function (_super) {
        ...
        ChartOfTimeScale.prototype.render = function (viewStartTickIndex, viewEndTickIndex) {
            ...
            var context = this.refContext();
            var localTimeOffsetMsec = context.getTickLocalTimeOffsetMsec();
            for (var i = viewStartTickIndex; i <= viewEndTickIndex; ++i) {
                var timeScaleElement = timeScaleElements[i];
                ...
                if (null != spanType) {
                    ...
                    var time = tickData.getDatetime().getTime();
                    time = time - localTimeOffsetMsec;
                    var s = CscApi.Utility.formatUTCTimestamp(time, pattern, timezoneOffsetInMinutes);
        ...
        ChartOfTimeScale.prototype.renderValueInfo = function (focusElementIndex) {
            ...
            var timeScale = this.refTimeScale();
            var timeScaleElements = timeScale.getTimeScaleElements();
            if (focusElementIndex > timeScaleElements.length - 1) {
                focusElementIndex = timeScaleElements.length - 1;
            }
            var timeScaleElement = timeScaleElements[focusElementIndex];
            if (timeScaleElement == null) {
                console.error('time scale element is not existing.');
                return;
            }
            var candlestickChart = this.refCandlestickChart();
            var style = candlestickChart.getStyle();
            ...
            if (tickData == null) {
                console.error('tick data is not existing.');
                return;
            }
            ...
            var localTimeOffsetMsec = context.getTickLocalTimeOffsetMsec();
            time = time - localTimeOffsetMsec;
            var dateInTimezone = new Date(CscApi.Utility.offsetTimestampByMinutes(time, candlestickChart.getTimezoneOffsetInMinutes()));
            var scaleType = timeScale.getScaleType();
            CscApi.Utility.anchorProfile();
            var text;
            if (this.dateFormatterCallback != null) {
                text = this.dateFormatterCallback(dateInTimezone);
            }
            else {
                var pattern = 'yyyy/MM/dd hh:mm';
                text = CscApi.Utility.formatUTCTimestamp(time, pattern, candlestickChart.getTimezoneOffsetInMinutes());
            }
            ...
            renderer.strokeRect(x - 2, y - 2, textWidth + 4, textHeight + 4);
        };
        ChartOfTimeScale.prototype.setDateFormatter = function (callback) {
            this.dateFormatterCallback = callback;
        };
...
(function (CscImpl) {
    ...
    var DrawerOfGoldenBands = (function (_super) {
        ...
        function DrawerOfGoldenBands(chart, handleId) {
            ...
            this.pathOfLine1 = CscApi.createStrokePath();
            this.pathOfLine2 = CscApi.createStrokePath();
            this.pathOfAxisLine = CscApi.createStrokePath();
            this.pathOfLineBands = [];
            var pathOfLineBands = this.pathOfLineBands;
            for (var i = 0; i < NUMBER_OF_BANDS; ++i) {
                pathOfLineBands[i] = CscApi.createStrokePath();
            }
        }
        ...
        DrawerOfGoldenBands.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
            this.setStyleLine2ColorRgba(colorRgba);
        };
        ...
        DrawerOfGoldenBands.prototype.setStyleLine1Width = function (lineWidth) {
            this.styleLine1Width = lineWidth;
            this.config.params['line1Width'].value = lineWidth;
        };
        ...
        DrawerOfGoldenBands.prototype.setStyleLine1DashedLength = function (dashedLength) {
            this.styleLine1DashedLength = dashedLength;
            this.config.params['line1DashedLength'].value = dashedLength;
        };
        ...
        DrawerOfGoldenBands.prototype.setStyleLine1ColorRgba = function (colorRgba) {
            this.styleLine1ColorRgba = colorRgba;
            this.config.params['line1ColorRgba'].value = colorRgba;
        };
        ...
        DrawerOfGoldenBands.prototype.setStyleLine2Width = function (lineWidth) {
            ...
            this.config.params['line2Width'].value = lineWidth;
        };
        ...
        DrawerOfGoldenBands.prototype.setStyleLine2DashedLength = function (dashedLength) {
            ...
            this.config.params['line2DashedLength'].value = dashedLength;
        };
        ...
        DrawerOfGoldenBands.prototype.setStyleLine2ColorRgba = function (colorRgba) {
            ...
            this.config.params['line2ColorRgba'].value = colorRgba;
        };
        DrawerOfGoldenBands.prototype.render = function () {
            ...
            if (viewLine1ext != null) {
                ...
                this.pathOfLine1.setPathAsLine(viewLine1ext.getX1(), viewLine1ext.getY1(), viewLine1ext.getX2(), viewLine1ext.getY2(), 5);
            }
            if (viewLine2ext != null) {
                ...
                this.pathOfLine2.setPathAsLine(viewLine2ext.getX1(), viewLine2ext.getY1(), viewLine2ext.getX2(), viewLine2ext.getY2(), 5);
                ...
                if (p1 && p2) {
                    for (var i = 0; i < NUMBER_OF_BANDS; ++i) {
                        ...
                        if (viewDivisionLine) {
                            ...
                            this.pathOfLineBands[i].setPathAsLine(viewDivisionLine.getX1(), viewDivisionLine.getY1(), viewDivisionLine.getX2(), viewDivisionLine.getY2(), 5);
                        }
                        else {
                            this.pathOfLineBands[i].resetPath();
                        }
                    }
                    this.drawLineFromEndPoints(p1.getX(), p1.getY(), p2.getX(), p2.getY(), this.styleLine2DashedLength);
                    this.pathOfAxisLine.setPathAsLine(p1.getX(), p1.getY(), p2.getX(), p2.getY(), 5);
                }
            }
        };
        DrawerOfGoldenBands.prototype.isHover = function (xInArea, yInArea) {
            if (this.pathOfLine1.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else if (this.pathOfLine2.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else if (this.pathOfAxisLine.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else {
                var pathOfLineBands = this.pathOfLineBands;
                for (var i = 0; i < NUMBER_OF_BANDS; ++i) {
                    if (pathOfLineBands[i].isPointInPath(xInArea, yInArea)) {
                        return true;
                    }
                }
            }
...
(function (CscImpl) {
    ...
    var ChartOfAo = (function (_super) {
        ...
        ChartOfAo.prototype.updateElements = function (updateTickFromIndex) {
            ...
            var sumLong = 0;
            var sumDiff = 0;
            var shortPeriodMidPriceList = [];
            var longPeriodMidPriceList = [];
            var numberOfCounted = 0;
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                var highPrice = tickData.getHigh();
                ...
                if (isNaN(highPrice) || isNaN(lowPrice)) {
                    elementMidList[i] = NaN;
                    elementAoList[i] = NaN;
                    continue;
                }
                var mid = elementMidList[i] = (highPrice + lowPrice) * 0.5;
                sumShort += mid;
                sumLong += mid;
                shortPeriodMidPriceList.push(mid);
                longPeriodMidPriceList.push(mid);
                if (numberOfCounted >= shortPeriod) {
                    sumShort -= shortPeriodMidPriceList.shift();
                    if (numberOfCounted >= longPeriod) {
                        sumLong -= longPeriodMidPriceList.shift();
...
(function (CscImpl) {
    ...
    var ChartOfMacd = (function (_super) {
        ...
        ChartOfMacd.prototype.setConfig = function (config) {
            ...
            this.argShortPeriod = Number(configShortPeriod.value);
            this.argLongPeriod = Number(configLongPeriod.value);
            this.argPeriodSignal = Number(configPeriodSignal.value);
            this.styleDiffLineWidth = Number(configDiffLineWidth.value);
            this.styleDiffLineColorRgba = configDiffLineColorRgba.value;
            this.styleDemLineWidth = Number(configDemLineWidth.value);
        ...
        ChartOfMacd.prototype.updateElements = function (updateTickFromIndex) {
            ...
            var sumLong = 0;
            var sumDiff = 0;
            var shortPeriodPriceList = [];
            var longPeriodPriceList = [];
            var diffPeriodPriceList = [];
            var numberOfCounted = 0;
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                var closePrice = tickData.getClose();
                if (isNaN(closePrice)) {
                    elementDiffList[i] = elementDemList[i] = elementMacdList[i] = NaN;
                    continue;
                }
                sumShort += closePrice;
                sumLong += closePrice;
                shortPeriodPriceList.push(closePrice);
                longPeriodPriceList.push(closePrice);
                if (numberOfCounted >= shortPeriod) {
                    sumShort -= shortPeriodPriceList.shift();
                    if (numberOfCounted >= longPeriod) {
                        sumLong -= longPeriodPriceList.shift();
                        var diff = sumShort / shortPeriod - sumLong / longPeriod;
                        elementDiffList[i] = diff;
                        sumDiff += diff;
                        diffPeriodPriceList.push(diff);
                        if (numberOfCounted >= longPeriod + periodSignal) {
                            sumDiff -= diffPeriodPriceList.shift();
...
(function (CscImpl) {
    ...
    var ChartOfOhlc = (function (_super) {
        ...
        function ChartOfOhlc(area, handleId, width, height) {
            ...
            this.viewLastClosePrice = null;
            this.viewLastClosePriceHorizontalLineYcoord = null;
        }
        ChartOfOhlc.prototype.setConfig = function (config) {
            config = this.cloneConfig(config);
            var params = config.params;
            var configOhlcType = params['ohlcType'];
            var configOhlcBarType = params['ohlcBarType'];
            var configCandlestickRisingColorRgba = params['candlestickRisingColorRgba'];
            var configCandlestickFallingColorRgba = params['candlestickFallingColorRgba'];
            var configBarRisingPositiveColorRgba = params['barRisingColorRgba'];
            var configBarNegativeColorRgba = params['barFallingColorRgba'];
        ...
        ChartOfOhlc.prototype.updateForRendering = function (viewStartTickIndex, viewEndTickIndex, areaLowestValue, areaHighestValue, pixelsPerValue, valueToYCoordConvertor, yAxisEnabled) {
            ...
            var numberOfTicks = orderedTickList.length;
            if (numberOfTicks > 0) {
                var lastTickData = orderedTickList[numberOfTicks - 1];
                var lastClosePrice = lastTickData.getClose();
                this.viewLastClosePrice = lastClosePrice;
                this.viewLastClosePriceHorizontalLineYcoord = valueToYCoordConvertor(lastClosePrice);
            }
            return yAxisEnabled ? this.generateValueScale(this.styleValueScaleSpanMargin, areaLowestValue, areaHighestValue, pixelsPerValue, valueToYCoordConvertor) : null;
        };
        ChartOfOhlc.prototype.render = function (viewStartTickIndex, viewEndTickIndex) {
            var renderer = this.refRenderer();
            var viewLastClosePriceHorizontalLineYcoord = this.viewLastClosePriceHorizontalLineYcoord;
            if (viewLastClosePriceHorizontalLineYcoord != null) {
                renderer.setStrokeColorRgba([255, 255, 255, 255]);
                renderer.setLineWidth(2);
                renderer.strokeDashedLine(4, 0, viewLastClosePriceHorizontalLineYcoord, this.width, viewLastClosePriceHorizontalLineYcoord);
            }
            ...
            var viewLastClosePrice = this.viewLastClosePrice;
            if (viewLastClosePrice != null) {
                var decimalDigits = this.getDecimalDigits();
                var viewLastClosePriceStr = CscApi.Utility.roundDown(viewLastClosePrice, decimalDigits).toFixed(decimalDigits);
                this.drawYScaleValue(viewLastClosePriceStr, viewLastClosePriceHorizontalLineYcoord);
            }
            return true;
        };
        ChartOfOhlc.prototype.renderTickAsCandlestick = function (viewStartTickIndex, viewEndTickIndex) {
            ...
            if (candleWidth > 1) {
                ...
                for (var i = viewStartTickIndex; i <= viewEndTickIndex; ++i) {
                    ...
                    var timeScaleElement = timeScaleElements[i];
                    if (element.rising) {
                        var timeScaleElementViewXCoord = timeScaleElement.viewXCoord;
                        var elementViewCandleStickLeftCoord = element.viewCandleStickLeftCoord;
                        var elementViewCandleStickTopCoord = element.viewCandleStickTopCoord;
                        var elementViewCandleStickHeight = element.viewCandleStickHeight;
                        renderer.strokeLine(timeScaleElementViewXCoord, element.viewUpperShadowTopCoord, timeScaleElementViewXCoord, elementViewCandleStickTopCoord);
                        renderer.strokeLine(timeScaleElementViewXCoord, elementViewCandleStickTopCoord + elementViewCandleStickHeight, timeScaleElementViewXCoord, element.viewLowerShadowBottomCoord);
                        renderer.fillRect(elementViewCandleStickLeftCoord, elementViewCandleStickTopCoord, candleWidth, elementViewCandleStickHeight);
                        renderer.strokeRect(elementViewCandleStickLeftCoord, elementViewCandleStickTopCoord, candleWidth, elementViewCandleStickHeight);
                    }
                }
        ...
        ChartOfOhlc.prototype.renderTickAsBars = function (viewStartTickIndex, viewEndTickIndex) {
            ...
            for (var i = viewStartTickIndex; i <= viewEndTickIndex; ++i) {
                ...
                if (element.rising) {
                    var timeScaleElementViewXCoord = timeScaleElement.viewXCoord;
                    var elementViewCandleStickTopCoord = element.viewCandleStickTopCoord;
                    renderer.strokeLine(timeScaleElementViewXCoord, element.viewUpperShadowTopCoord, timeScaleElementViewXCoord, element.viewLowerShadowBottomCoord);
                    var yCoordOfOpen = elementViewCandleStickTopCoord + element.viewCandleStickHeight;
                    renderer.strokeLine(Math.floor(timeScaleElementViewXCoord - halfBarWidth), yCoordOfOpen, Math.floor(timeScaleElementViewXCoord + barWidth * 0.5), yCoordOfOpen);
                    renderer.strokeLine(Math.floor(timeScaleElementViewXCoord - barWidth * 0.5), elementViewCandleStickTopCoord, Math.floor(timeScaleElementViewXCoord + halfBarWidth), elementViewCandleStickTopCoord);
                }
            }
            renderer.setStrokeColorRgba(styleSheddingBorderColorRgba);
            for (var i = viewStartTickIndex; i <= viewEndTickIndex; ++i) {
                ...
                if (false == element.rising) {
                    ...
                    var elementViewCandleStickTopCoord = element.viewCandleStickTopCoord;
                    renderer.strokeLine(timeScaleElementViewXCoord, element.viewUpperShadowTopCoord, timeScaleElementViewXCoord, element.viewLowerShadowBottomCoord);
                    var yCoordOfClose = elementViewCandleStickTopCoord + element.viewCandleStickHeight;
                    renderer.strokeLine(Math.floor(timeScaleElementViewXCoord - barWidth * 0.5), yCoordOfClose, Math.floor(timeScaleElementViewXCoord + halfBarWidth), yCoordOfClose);
                    renderer.strokeLine(Math.floor(timeScaleElementViewXCoord - halfBarWidth), elementViewCandleStickTopCoord, Math.floor(timeScaleElementViewXCoord + barWidth * 0.5), elementViewCandleStickTopCoord);
                }
            }
            renderer.translate(viewStartXCoord, 0);
        };
        ChartOfOhlc.prototype.renderValueInfo = function (focusElementIndex) {
            ...
            if (focusElementIndex != null) {
                ...
                if (focusElement) {
                    ...
                    if (0) {
                        valueInfoList = [
                            { name: 'O', value: CscApi.Utility.roundDown(tickData.getOpen(), decimalDigits).toFixed(decimalDigits), valueColor: null },
                            { name: 'H', value: CscApi.Utility.roundDown(tickData.getHigh(), decimalDigits).toFixed(decimalDigits), valueColor: null },
                            { name: 'L', value: CscApi.Utility.roundUp(tickData.getLow(), decimalDigits).toFixed(decimalDigits), valueColor: null },
                            { name: 'C', value: CscApi.Utility.roundDown(tickData.getClose(), decimalDigits).toFixed(decimalDigits), valueColor: null },
                            { name: 'IDX', value: focusElementIndex.toString(), valueColor: null },
                        ];
                    }
                    else {
                        valueInfoList = [
                            { name: 'O', value: tickData.getOpen().toString(), valueColor: null },
                            { name: 'H', value: tickData.getHigh().toString(), valueColor: null },
                            { name: 'L', value: tickData.getLow().toString(), valueColor: null },
                            { name: 'C', value: tickData.getClose().toString(), valueColor: null },
                            { name: 'IDX', value: focusElementIndex.toString(), valueColor: null },
                        ];
                    }
                }
...
(function (CscApi) {
    var SnGenerator = (function () {
        ...
        SnGenerator.prototype.allocate = function () {
            ...
            var currentSn = this.sn.toString();
            ++this.sn;
            return currentSn;
        };
...
(function (CscImpl) {
    ...
    var ChartOfBollingerBand = (function (_super) {
        ...
        ChartOfBollingerBand.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.argK = Number(configK.value);
            this.styleLineWidth = Number(configLineWidth.value);
        ...
        ChartOfBollingerBand.prototype.updateElements = function (updateTickFromIndex) {
            ...
            this.elementMaList[0] = this.elementLowerList[0] = this.elementUpperList[0];
            this.elementDiffSquareList[0] = 0;
            var periodSumPriceIndexList = [];
            var pi = NaN;
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                var closePrice = tickData.getClose();
                if (isNaN(closePrice)) {
                    var numberOfIndices = periodSumPriceIndexList.length;
                    if (numberOfIndices == 0) {
                        elementMaList[i] = elementLowerList[i] = elementUpperList[i] = NaN;
                        elementDiffSquareList[i] = 0;
                    }
                    else {
                        var idx = periodSumPriceIndexList[numberOfIndices - 1];
                        elementMaList[i] = elementMaList[idx];
                        elementLowerList[i] = elementLowerList[idx];
                        elementUpperList[i] = elementUpperList[idx];
                        elementDiffSquareList[i] = elementDiffSquareList[idx];
                    }
                    continue;
                }
                if (isNaN(pi)) {
                ...
                var prevTickData = orderedTickList[pi];
                var prevClosePrice = prevTickData.getClose();
                periodSumMa += prevClosePrice;
                periodSumDiffSquare += elementDiffSquareList[pi];
                periodSumPriceIndexList.push(i);
                var numberOfCountedElement = periodSumPriceIndexList.length;
                var p = Math.min(numberOfCountedElement, period);
                ...
                var diff = closePrice - ma;
                elementDiffSquareList[i] = diff * diff;
                if (periodSumPriceIndexList.length >= period) {
                    var bi = periodSumPriceIndexList.shift();
...
(function (CscImpl) {
    ...
    var ChartOfAtr = (function (_super) {
        ...
        ChartOfAtr.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleAtrLineWidth = Number(configAtrLineWidth.value);
        ...
        ChartOfAtr.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                var tr = void 0;
                if (numberOfCounted > 0) {
                    var pi = periodIndexList[periodIndexList.length - 1];
                    var prevTickData = orderedTickList[pi];
                    var prevClose = prevTickData.getClose();
                    tr = elementTrList[i] = Math.max(highPrice, prevClose) - Math.min(lowPrice, prevClose);
                }
                else {
                    tr = elementTrList[i] = highPrice - lowPrice;
                }
                if (numberOfCounted >= period) {
                    elementAtrList[i] = sumTr / period;
                    var deductedIndex = periodIndexList.shift();
                    sumTr -= elementTrList[deductedIndex];
                }
                else {
                    elementAtrList[i] = NaN;
                }
...
(function (CscApi) {
    (function (PathType) {
        ...
        PathType[PathType["FAN"] = 2] = "FAN";
    })(CscApi.PathType || (CscApi.PathType = {}));
    var PathType = CscApi.PathType;
    var isPointInStrokeSupported = null;
    (function () {
        var canvas = document.createElement('canvas');
        var ctx = canvas.getContext('2d');
        isPointInStrokeSupported = undefined != ctx.isPointInStroke;
    })();
    function createStrokePath() {
        if (isPointInStrokeSupported) {
            return new CscApi.StrokePathImpl();
        }
        return new CscApi.StrokePathCompatible();
    }
    CscApi.createStrokePath = createStrokePath;
})(CscApi || (CscApi = {}));
var CscImpl;
(function (CscImpl) {
    var TYPE_SPANS = {};
    ...
    var TimeScale = (function () {
        ...
        TimeScale.prototype.setContext = function (context) {
        ...
        TimeScale.prototype.update = function (tickDataIsDirty) {
            ...
            var style = candlestickChart.getStyle();
            var context = this.context;
            var orderedTickList = context != null ? context.getOrderedTickList() : [];
            var numberOfOrderedTickList = orderedTickList.length;
            var spanTypes = [
                CscApi.SpanTypeEnum.MINUTE,
                CscApi.SpanTypeEnum.HOUR,
            ...
            var betweenScaleHalfWidth = this.betweenScaleHalfWidth;
            var numberOfSpanTypes = spanTypes.length;
            for (var i = 0; i < numberOfSpanTypes; ++i) {
                var pattern = CscImpl.FMT_SCALE_ALL_SPANS[i];
                var reserveChacacterSize = Math.ceil(pattern.length * 1.618);
                var prev = betweenScaleHalfWidth[i];
                var current = betweenScaleHalfWidth[i] = Math.floor(style.getTimeScaleFontSize(i) * reserveChacacterSize * 0.5);
                if (prev != current) {
            ...
            if (numberOfOrderedTickList > 0) {
                ...
                if (offsetTimeOfBegin.getUTCFullYear() != offsetTimeOfEnd.getUTCFullYear()) {
                    this.generateSpansForUpdating(orderedTickList, 0, endIndex, spanTypeEnum.YEAR, 'getUTCFullYear');
                }
                else if (offsetTimeOfBegin.getUTCMonth() != offsetTimeOfEnd.getUTCMonth()) {
                    this.generateSpansForUpdating(orderedTickList, 0, endIndex, spanTypeEnum.MONTH, 'getUTCMonth');
                }
                else if (offsetTimeOfBegin.getUTCDate() != offsetTimeOfEnd.getUTCDate()) {
                    this.generateSpansForUpdating(orderedTickList, 0, endIndex, spanTypeEnum.DAY, 'getUTCDate');
                }
                else if (offsetTimeOfBegin.getUTCHours() != offsetTimeOfEnd.getUTCHours()) {
                    this.generateSpansForUpdating(orderedTickList, 0, endIndex, spanTypeEnum.HOUR, 'getUTCHours');
                }
                else if (offsetTimeOfBegin.getUTCMinutes() != offsetTimeOfEnd.getUTCMinutes()) {
                    this.generateSpansForUpdating(orderedTickList, 0, endIndex, spanTypeEnum.MINUTE, 'getUTCMinutes');
                }
                else {
                }
            }
        ...
        TimeScale.prototype.generateSpansForUpdating = function (orderedTickList, fromIndex, toIndex, spanType, getterOnDate) {
            ...
            var spanTypeEnum = CscApi.SpanTypeEnum;
            if (spanType !== spanTypeEnum.MINUTE) {
                ...
                while (++i <= toIndex) {
                    ...
                    if (n1 !== n2) {
                        ...
                        var elementViewXCoord = element.viewXCoord;
                        var xFrom = elementViewXCoord - scaleHalfWidth;
                        var xTo = elementViewXCoord + scaleHalfWidth;
                ...
                switch (spanType) {
                    case spanTypeEnum.HOUR:
                        nextSpanType = spanTypeEnum.MINUTE;
                        nextGetterOnDate = 'getUTCMinutes';
                        break;
                    case spanTypeEnum.DAY:
                        nextSpanType = spanTypeEnum.HOUR;
                        nextGetterOnDate = 'getUTCHours';
                        break;
                    case spanTypeEnum.MONTH:
                        nextSpanType = spanTypeEnum.DAY;
                        nextGetterOnDate = 'getUTCDate';
                        break;
                    case spanTypeEnum.YEAR:
                        nextSpanType = spanTypeEnum.MONTH;
...
(function (CscImpl) {
    ...
    var DrawerOfGannFan = (function (_super) {
        ...
        function DrawerOfGannFan(chart, handleId) {
            ...
            this.pathOfHorizontalLineList = CscApi.createStrokePath();
            this.pathOfVerticalLineList = CscApi.createStrokePath();
            var pathOfLineList = this.pathOfLineList = [];
            var numberOfLines = lineScales.length;
            for (var i = 0; i < numberOfLines; ++i) {
                pathOfLineList.push(CscApi.createStrokePath());
            }
        }
        ...
        DrawerOfGannFan.prototype.setColor = function (colorRgba) {
            this.setStyleFanLineColorRgba(colorRgba);
        };
        DrawerOfGannFan.prototype.getStyleFanLineWidth = function () {
            return this.styleFanLineWidth;
        };
        DrawerOfGannFan.prototype.setStyleFanLineWidth = function (lineWidth) {
            this.styleFanLineWidth = lineWidth;
            this.config.params['fanLineWidth'].value = lineWidth;
        };
        DrawerOfGannFan.prototype.getStyleFanLineDashedLength = function () {
            return this.styleFanLineDashedLength;
        };
        DrawerOfGannFan.prototype.setStyleFanLineDashedLength = function (dashedLength) {
            this.styleFanLineDashedLength = dashedLength;
            this.config.params['fanLineDashedLength'].value = dashedLength;
        };
        DrawerOfGannFan.prototype.getStyleFanLineColorRgba = function () {
            return this.styleFanLineColorRgba;
        };
        DrawerOfGannFan.prototype.setStyleFanLineColorRgba = function (colorRgba) {
            this.styleFanLineColorRgba = colorRgba;
            this.config.params['fanLineColorRgba'].value = colorRgba;
        };
        DrawerOfGannFan.prototype.render = function () {
            ...
            this.pathOfHorizontalLineList.setPathAsLine(horizontalLine.getX1(), horizontalLine.getY1(), horizontalLine.getX2(), horizontalLine.getY2(), 5);
            ...
            this.pathOfVerticalLineList.setPathAsLine(verticalLine.getX1(), verticalLine.getY1(), verticalLine.getX2(), verticalLine.getY2(), 5);
            if (dx != 0) {
                ...
                for (var i = 0; i < numberOfLines; ++i) {
                    ...
                    pathOfLineList[i].setPathAsLine(line.getX1(), line.getY1(), line.getX2(), line.getY2(), 5);
                }
            }
        };
        DrawerOfGannFan.prototype.isHover = function (xInArea, yInArea) {
            if (this.pathOfHorizontalLineList.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else if (this.pathOfVerticalLineList.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else {
                var pathOfLineList = this.pathOfLineList;
                var numberOfLines = lineScales.length;
                for (var i = 0; i < numberOfLines; ++i) {
                    if (pathOfLineList[i].isPointInPath(xInArea, yInArea)) {
                        return true;
                    }
                }
            }
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                if (numberOfCounted >= shortPeriod) {
                    ...
                    if (numberOfCounted >= longPeriod) {
                        ...
                        elementDiffList[i] = diff;
                        sumDiff += diff;
                        periodDiffList.push(diff);
                        if (numberOfCounted >= longPeriod + periodSignal) {
                            sumDiff -= periodDiffList.shift();
                            var dem = sumDiff / periodSignal;
                            elementDemList[i] = dem;
                            elementMacdList[i] = diff - dem;
                        }
...
(function (CscImpl) {
    var DrawerOfPriceTangent = (function (_super) {
        ...
        DrawerOfPriceTangent.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
        };
        ...
        DrawerOfPriceTangent.prototype.isHover = function (xInArea, yInArea) {
            var pathOfLine1 = this.pathOfLine1;
            return pathOfLine1.isPointInPath(xInArea, yInArea);
        };
...
(function (CscFacade) {
    var CandlestickChartFacade = (function () {
        ...
        CandlestickChartFacade.prototype.getContext = function () {
            return this.candlestickChart.getContextById('main');
        };
        CandlestickChartFacade.prototype.setContext = function (context) {
            this.candlestickChart.bindContext('main', context);
        };
        ...
        CandlestickChartFacade.prototype.init = function (domCanvas) {
            ...
            candlestickChart.bindContext('main', new CscImpl.Context(0));
            ...
            chartOfOhlc.setSourceContextId('main');
            this.tiMap['ohlc'] = {
                area: areaOfMain,
                chart: chartOfOhlc,
                tiIndex: null,
            ...
            var chartOfTimeScale = areaOfTimeScale.getChart(chartIdOfTimeScale);
            chartOfTimeScale.setSourceContextId('main');
            chartOfTimeScale.setDateFormatter(function (date) {
                return _this.dateFormatter(date);
            });
        ...
        CandlestickChartFacade.prototype.resize = function () {
            ...
            var touchControlFocusLineDistanceThreshold = Math.min(Math.max(width / 30, 15), 40);
            this.candlestickChart.setTouchControlFocusLineDistanceThreshold(touchControlFocusLineDistanceThreshold);
            this.reshapeAreas();
            this.present();
        };
        ...
        CandlestickChartFacade.prototype.reshapeAreas = function () {
            ...
            for (var n = 0; n < 2; ++n) {
                ...
                if (numberOfAreaOfIndependentTi > 0) {
                    ...
                    var offsetHeight = heightOfTiArea + stylePaddingHeightOfAreas;
                ...
                if (n == 0) {
                    var paddingWidth = 10;
                    yScaleWidth = this.getYScaleWidth() + paddingWidth;
        ...
        CandlestickChartFacade.prototype.getViewStartXCoord = function () {
            return this.candlestickChart.getViewStartXCoord();
        };
        ...
        CandlestickChartFacade.prototype.getViewEndXCoord = function () {
            return this.candlestickChart.getViewEndXCoord();
        };
        CandlestickChartFacade.prototype.setViewEndXCoord = function (xCoord) {
            this.candlestickChart.setViewEndXCoord(xCoord);
            this.present();
        };
        CandlestickChartFacade.prototype.getViewTickWidth = function () {
            return this.candlestickChart.getViewTickWidth();
        };
        CandlestickChartFacade.prototype.setViewTickWidth = function (tickWidth, viewAlignMode, viewAlignBasis) {
            var candlestickChart = this.candlestickChart;
            candlestickChart.setViewTickWidthWithViewAlign(tickWidth, viewAlignMode, viewAlignBasis);
        };
        CandlestickChartFacade.prototype.setViewTickWidthByNumber = function (numberOfTicksInView, viewAlignMode, viewAlignBasis) {
            this.reshapeAreas();
            var areaWidth = this.areaOfMain.getWidth();
            var tickWidth = areaWidth / numberOfTicksInView;
            this.setViewTickWidth(tickWidth, viewAlignMode, viewAlignBasis);
        };
        ...
        CandlestickChartFacade.prototype.getValueInfoVisible = function () {
            return this.valueInfoVisible;
        };
        CandlestickChartFacade.prototype.setValueInfoVisible = function (visible) {
            this.valueInfoVisible = visible;
            this.areaOfMain.setValueInfoVisible(visible);
            var areaOfIndependentTiList = this.areaOfIndependentTiList;
            var numberOfIndependentTiAreas = areaOfIndependentTiList.length;
            for (var i = 0; i < numberOfIndependentTiAreas; ++i) {
                var area = areaOfIndependentTiList[i];
                area.setValueInfoVisible(visible);
            }
            this.present();
        };
        CandlestickChartFacade.prototype.getPixelRatio = function () {
            if (this.candlestickChart == null) {
                return 1;
            }
            return this.candlestickChart.getPixelRatio();
        };
        CandlestickChartFacade.prototype.addTi = function (tiId, chartType, sourceContextId) {
            ...
            var tiContext;
            var chart;
            var areaOfMain = this.areaOfMain;
            switch (chartType) {
                case CscApi.ChartType.OHLC:
                case CscApi.ChartType.MA:
                case CscApi.ChartType.BOLLINGER_BAND:
                case CscApi.ChartType.SAR:
                    var chartId = areaOfMain.addChart(chartType);
                    var chartOrderingIndex = areaOfMain.getChartOrderingIndex(chartId);
                    chart = areaOfMain.getChart(chartId);
                    areaOfMain.setChartYAxisEnabled(chartId, false);
                    tiContext = {
                        area: areaOfMain,
                        chart: chart,
                        tiIndex: chartOrderingIndex,
                    };
                    areaOfMain.setChartYAxisEnabled(chart.getHandleId(), false);
                    areaOfMain.setValueInfoVisible(this.valueInfoVisible);
                    break;
                default:
                    var candlestickChart = this.candlestickChart;
                    var areaId = candlestickChart.addArea(20, 420, 1100, 250);
                    var area = candlestickChart.getArea(areaId);
                    area.reconcileViewFromArea(areaOfMain);
                    ...
                    area.setValueInfoVisible(this.valueInfoVisible);
                    area.setFocusElementIndex(areaOfMain.getFocusElementIndex());
                    break;
            }
            chart.setSourceContextId(sourceContextId);
            if (tiContext != null) {
        ...
        CandlestickChartFacade.prototype.removeTi = function (id) {
            ...
            if (tiContext.area == this.areaOfMain) {
                var charOrderingIndex = area.getChartOrderingIndex(tiContext.chart.getHandleId());
                area.removeChart(tiContext.chart.getHandleId());
                for (var tempTiId in tiMap) {
                    var tempTiMap = tiMap[tempTiId];
                    if (tempTiMap.area == this.areaOfMain) {
                        tempTiMap.tiIndex = tempTiMap.area.getChartOrderingIndex(tempTiMap.chart.getHandleId());
                    }
                }
            }
            else {
                ...
                if (chartList.length == 0) {
                    ...
                    for (var tempTiId in tiMap) {
                        var tempTiMap = tiMap[tempTiId];
                        if (tempTiMap.area != this.areaOfMain && tempTiMap.tiIndex > tiIndex) {
                            --tempTiMap.tiIndex;
                        }
                    }
                    this.reshapeAreas();
        ...
        CandlestickChartFacade.prototype.setTiArg = function (id, paramName, value) {
            ...
            var result = tiContext.chart.setArgValueByName(paramName, value);
            this.present();
            return result;
        };
        ...
        CandlestickChartFacade.prototype.setTiValueInfoVisibled = function (id, visible) {
            var tiContext = this.tiMap[id];
            if (tiContext == null) {
                console.warn('unknown technical indicator ID: ' + id);
                return;
            }
            tiContext.chart.setValueInfoVisible(visible);
            this.present();
        };
        ...
        CandlestickChartFacade.prototype.startToDraw = function (drawerId, drawerType, commitSteps, persistent) {
            if (persistent === undefined) {
                persistent = true;
            }
            this.stopDrawing();
            if (this.drawerMap[drawerId] != null) {
                return;
            }
        ...
        CandlestickChartFacade.prototype.setDrawerColorRgba = function (drawerId, colorRgba) {
            var drawerContext = this.drawerMap[drawerId];
            if (drawerContext == null) {
                return false;
            }
            ...
            drawer.setColor(colorRgba);
            this.present();
            return true;
        };
        CandlestickChartFacade.prototype.setTimeScaleDateFormatter = function (callback) {
        ...
        CandlestickChartFacade.prototype.saveToJson = function (options) {
            ...
            if (extractAll || options.ti) {
                ...
                for (var tiId in this.tiMap) {
                    ...
                    var chart = tiContext.chart;
                    tiMap[tiId] = {
                        tiType: chart.getType(),
                        index: tiContext.tiIndex,
                        tiConfig: chart.getConfig(),
                        mainArea: tiContext.area == this.areaOfMain,
                    };
                }
            }
            if (extractAll || options.drawing) {
                result.drawerMap = {};
                var resultDrawerMap = result.drawerMap;
                var drawerMap = this.drawerMap;
                for (var drawerId in drawerMap) {
                    var drawerContext = drawerMap[drawerId];
                    if (drawerContext.persistent != true) {
                        continue;
                    }
                    var drawer = drawerContext.drawer;
                    resultDrawerMap[drawerId] = {
                        drawerType: drawer.getType(),
                        drawnStepList: drawer.getDrawnStepList(),
                        drawerConfig: drawer.getConfig(),
                    };
                }
            }
        ...
        CandlestickChartFacade.prototype.restoreFromJson = function (options, json) {
            ...
            if (extractAll || options.ti) {
                ...
                var orderedMainAreaTiMap = new CscApi.OrderedHashMap();
                for (var tiId in jsObj.tiMap) {
                    ...
                    if (ti.mainArea) {
                        ...
                        orderedMainAreaTiMap.Put(ti.index, tiId);
                    }
                }
                this.removeAllTi();
                var mainAreaTiIdList = orderedMainAreaTiMap.GetOrderedValueList();
                for (var i_1 in mainAreaTiIdList) {
                    var tiId_1 = mainAreaTiIdList[i_1];
                    var ti = jsObj.tiMap[tiId_1];
                ...
                for (var i_2 in tiIdList) {
                    var tiId_2 = tiIdList[i_2];
...
(function (CscImpl) {
    ...
    var ChartOfObv = (function (_super) {
        ...
        ChartOfObv.prototype.setConfig = function (config) {
            ...
            this.argObvPeriod = Number(configObvPeriod.value);
            this.argObvMaPeriod = Number(configObvMaPeriod.value);
            this.styleObvLineWidth = Number(configObvLineWidth.value);
            this.styleObvLineColorRgba = configObvLineColorRgba.value;
            this.styleObvMaLineWidth = Number(configObvMaLineWidth.value);
        ...
        ChartOfObv.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                var tickData = orderedTickList[i];
                var closePrice = tickData.getClose();
                var volume = tickData.getVolume();
                if (isNaN(closePrice) || isNaN(volume)) {
                    elementObvList[i] = elementObvMaList[i] = NaN;
                    continue;
                }
                if (false == isNaN(pi)) {
                    var prevTickData = orderedTickList[pi];
                    var prevClosePrice = prevTickData.getClose();
                    var vol = elementVolList[i] = closePrice > prevClosePrice ? volume : -volume;
                    sumVolume += vol;
                    periodVolList.push(vol);
                    if (numberOfCounted >= obvPeriod) {
                        sumVolume -= periodVolList.shift();
                    }
                    var obv = elementObvList[i] = sumVolume;
                    sumObv += obv;
                    periodObvList.push(obv);
                    if (numberOfCounted >= obvMaPeriod) {
                        sumObv -= periodObvList.shift();
                    }
                    var p = numberOfCounted < obvMaPeriod ? numberOfCounted + 1 : obvMaPeriod;
    ...
    var Renderer = (function () {
        ...
        Renderer.prototype.updateFontAttribute = function () {
            if (this.textFontAttrIsDirty) {
                ...
                this.ctx.font = (this.textFontBold ? 'bold ' : '') + this.textFontSize + 'px ' + this.textFontName;
            }
        };
        ...
        Renderer.prototype.setTextBaseLineToBottom = function () {
        ...
        Renderer.prototype.strokeLineStrips = function (vector2dComponentList, startPointIndex, numberOfPoints, stridePoints) {
            ...
            var moved;
            var x = vector2dComponentList[lowerBound];
            var y = vector2dComponentList[++lowerBound];
            if (false == isNaN(x) && false == isNaN(y)) {
                ctx.moveTo(x, y);
                moved = true;
            }
            else {
            ...
            for (var i = lowerBound + 1; i <= upperBound; i += strideIndex) {
                var x_1 = vector2dComponentList[i];
                if (isNaN(x_1)) {
                    moved = false;
                    continue;
                }
                var y_1 = vector2dComponentList[i + 1];
                if (isNaN(y_1)) {
                    moved = false;
                    continue;
                }
...
(function (CscImpl) {
    ...
    var ChartOfWr = (function (_super) {
        ...
        ChartOfWr.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleWrLineWidth = Number(configWrLineWidth.value);
        ...
        ChartOfWr.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                if (numberOfCounted >= period) {
                    ...
                    var periodHigh = Number.NEGATIVE_INFINITY;
                    for (var n = 0; n < period; ++n) {
                        var bi = periodIndexList[n];
                        var periodTickData = orderedTickList[bi];
                    ...
                    elementWrList[i] = 100 * (periodHigh - closePrice) / (periodHigh - periodLow);
...
(function (CscImpl) {
    var ContextAdapter = (function () {
        function ContextAdapter(candlestickChart) {
            this.candlestickChart = candlestickChart;
            this.uniqueMode = true;
            this.uniqueContextId = null;
            this.uniqueContext = null;
            this.uniqueEventHandleId = null;
            this.combinedContext = null;
            this.callbackOfTickUpdated = null;
            this.callbackOfTickRemoved = null;
        }
        ContextAdapter.prototype.getAnyEvaluatedContext = function () {
            if (this.uniqueMode) {
                return this.uniqueContext != null ? this.uniqueContext : null;
            }
            else {
                return this.combinedContext.getAnyEvaluatedContext();
            }
        };
        ContextAdapter.prototype.getContextIdList = function () {
            if (this.uniqueMode) {
                return [this.uniqueContextId];
            }
            else {
                return this.combinedContext.getContextIdList();
            }
        };
        ContextAdapter.prototype.getLowerBoundTickIndexByTime = function (tickTimeInMsec) {
            if (this.uniqueMode) {
                var uniqueContext = this.uniqueContext;
                var tickIndex = uniqueContext.getLowerBoundTickIndexByTime(tickTimeInMsec);
                return tickIndex;
            }
            else {
                var combinedContext = this.combinedContext;
                var contextIdList = combinedContext.getContextIdList();
                var numberOfContexts = contextIdList.length;
                for (var i = 0; i < numberOfContexts; ++i) {
                    var contextId = contextIdList[i];
                    var context = combinedContext.getBoundContext(contextId);
                    var tickIndex = context.getLowerBoundTickIndexByTime(tickTimeInMsec);
                    if (tickIndex != null) {
                        return tickIndex;
                    }
                }
        ...
        ContextAdapter.prototype.getLowerBoundTicksByTime = function (tickTimeInMsec) {
            var ticks = [];
            if (this.uniqueMode) {
                var uniqueContext = this.uniqueContext;
                var tickIndex = uniqueContext.getLowerBoundTickIndexByTime(tickTimeInMsec);
                var orderedTickList = uniqueContext.getOrderedTickList();
                var tick = orderedTickList[tickIndex];
                if (tick != null) {
                    ticks.push(tick);
                }
            }
        ...
        ContextAdapter.prototype.getBoundContext = function (contextId) {
            if (this.uniqueMode) {
                if (contextId === this.uniqueContextId) {
                    return this.uniqueContext;
                }
                else {
                    return null;
                }
                ...
                var boundContext = this.combinedContext.getBoundContext(contextId);
                return boundContext != null ? boundContext : null;
            }
        };
        ContextAdapter.prototype.bindContext = function (contextId, context) {
            var _this = this;
            if (this.uniqueMode) {
                if (this.uniqueContextId == null || contextId === this.uniqueContextId) {
                    this.uniqueContextId = contextId;
                    this.uniqueContext = context;
                    this.uniqueEventHandleId = context.addEventListenerOnTickUpdated(function (modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
                        return _this.fireEventOfTickUpdated(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
                    });
                }
                else {
                    this.combinedContext = new CscImpl.ContextHomogenizer();
                    this.combinedContext.setContextTickUpdatedCallback(function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
                        _this.fireEventOfTickUpdated(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
                    });
                    this.combinedContext.setContextTickRemovedCallback(function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList) {
                        _this.fireEventOfTickRemoved(contextId, modifiedLowerestIndex, changedKeyList, changedValueList);
                    });
                    this.combinedContext.bindContext(this.uniqueContextId, this.uniqueContext);
                    this.uniqueMode = false;
                    this.uniqueContext.removeEventListener(this.uniqueEventHandleId);
                    this.uniqueContext = null;
                    this.uniqueEventHandleId = null;
                    this.combinedContext.bindContext(contextId, context);
                }
            }
            else {
                this.combinedContext.bindContext(contextId, context);
        ...
        ContextAdapter.prototype.unbindContext = function (contextId) {
            var _this = this;
            if (this.uniqueMode) {
                if (contextId === this.uniqueContextId) {
                    this.uniqueContext.removeEventListener(this.uniqueEventHandleId);
                ...
                this.combinedContext.unbindContext(contextId);
                var combinedContextIdList = this.combinedContext.getContextIdList();
                var numberOfContextInCombinedContext = combinedContextIdList.length;
                if (numberOfContextInCombinedContext == 0) {
                    this.uniqueMode = true;
                }
                else if (numberOfContextInCombinedContext == 1) {
                    this.uniqueMode = true;
                    this.uniqueContextId = combinedContextIdList[0];
                    this.uniqueContext = this.combinedContext.getBoundContext(this.uniqueContextId);
                    this.combinedContext.unbindContext(this.uniqueContextId);
                    this.combinedContext = null;
                    this.uniqueEventHandleId = this.uniqueContext.addEventListenerOnTickUpdated(function (modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
                        _this.fireEventOfTickUpdated(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
                    });
                }
            }
        };
        ContextAdapter.prototype.getEvaluatedContext = function (contextId) {
            if (this.uniqueMode) {
                if (this.uniqueContextId == contextId) {
                    return this.uniqueContext;
                }
                else {
                    return null;
                ...
                return this.combinedContext.getEvaluatedContext(contextId);
            }
        };
        ContextAdapter.prototype.getContextTickUpdatedCallback = function () {
            return this.callbackOfTickUpdated;
        };
        ContextAdapter.prototype.setContextTickUpdatedCallback = function (callback) {
            this.callbackOfTickUpdated = callback;
        };
        ContextAdapter.prototype.getContextTickRemovedCallback = function () {
            return this.callbackOfTickRemoved;
        };
        ContextAdapter.prototype.setContextTickRemovedCallback = function (callback) {
            this.callbackOfTickRemoved = callback;
        };
        ContextAdapter.prototype.fireEventOfTickUpdated = function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
            if (this.callbackOfTickUpdated) {
                this.callbackOfTickUpdated(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
            }
        };
        ContextAdapter.prototype.fireEventOfTickRemoved = function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList) {
            if (this.callbackOfTickRemoved) {
                this.callbackOfTickRemoved(contextId, modifiedLowerestIndex, changedKeyList, changedValueList);
            }
        };
        return ContextAdapter;
    }());
    CscImpl.ContextAdapter = ContextAdapter;
})(CscImpl || (CscImpl = {}));
var CscImpl;
(function (CscImpl) {
    var DECIMAL_DIGITS = 4;
    var ChartOfSar = (function (_super) {
        ...
        ChartOfSar.prototype.setConfig = function (config) {
            ...
            this.argAfInit = Number(configSarAfInit.value);
            this.argAfStep = Number(configSarAfStep.value);
            this.argAfLimit = Number(configSarAfLimit.value);
            this.styleSarDotSize = Number(configSarDotWidth.value);
        ...
        ChartOfSar.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                var openPrice = tickData.getOpen();
                if (isNaN(closePrice) || isNaN(openPrice)) {
                    elementSarRisingList[i] = elementSarList[i] = elementSarEpList[i] = NaN;
                    continue;
                }
                if (isNaN(pi)) {
                    elementSarAfList[i] = afInit;
                    var isRising = closePrice >= openPrice;
                    if (isRising) {
                    ...
                    var prevAf = elementSarAfList[pi];
                    var prevEp = elementSarEpList[pi];
                    var prevSar = elementSarList[pi];
                    var prevSarIsRising = elementSarRisingList[pi] > 0 ? true : false;
                    var sar;
                    if (prevSarIsRising) {
...
var CscImpl;
(function (CscImpl) {
    var MappedContext = (function () {
        function MappedContext(contextId, boundContext, ticks) {
        ...
        MappedContext.prototype.beDirty = function () {
            this.orderedTickListIsDirty = true;
        };
        MappedContext.prototype.removeEventListeners = function () {
            var boundContext = this.boundContext;
            boundContext.removeEventListener(this.tickUpdatedEventHandleId);
            boundContext.removeEventListener(this.tickRemovedEventHandleId);
            this.tickUpdatedEventHandleId = null;
            this.tickRemovedEventHandleId = null;
        };
        MappedContext.prototype.getBoundContext = function () {
            return this.boundContext;
        };
        MappedContext.prototype.getOrderedTickList = function () {
            if (this.orderedTickListIsDirty == true) {
                this.orderedTickListIsDirty = false;
                var contextId = this.contextId;
                var orderedKey = this.ticks.RefOrderedKeys();
                var orderedValueList = this.ticks.GetOrderedValueList();
                var numberOfValues = orderedValueList.length;
                this.orderedTickList.length = 0;
                for (var i = 0; i < numberOfValues; ++i) {
                    var tickDataMap = orderedValueList[i];
                    var tickData = tickDataMap[contextId];
                    if (tickData != null) {
                        this.orderedTickList.push(tickData);
                    }
                    else {
                        var emptyTickData = new CscApi.TickData();
                        emptyTickData.setOpen(NaN);
                        emptyTickData.setHigh(NaN);
                        emptyTickData.setLow(NaN);
                        emptyTickData.setClose(NaN);
                        emptyTickData.setDatetime(new Date(orderedKey[i]));
                        this.orderedTickList.push(emptyTickData);
                    }
                }
            }
            return this.orderedTickList;
        };
        MappedContext.prototype.getLowerBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
            var lowerBound = boundaries[0];
            if (lowerBound != null) {
                return lowerBound.index;
        ...
        MappedContext.prototype.getUpperBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
            var upperBound = boundaries[1];
            if (upperBound != null) {
                return upperBound.index;
        ...
        MappedContext.prototype.getLowerBoundOrUpperBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
            var lowerBound = boundaries[0];
            if (lowerBound != null) {
                return lowerBound.index;
        ...
        MappedContext.prototype.getUpperBoundOrLowerBoundTickIndexByTime = function (tickTimeInMsec) {
            var boundaries = this.ticks.FindKeyBoundaryPointers(tickTimeInMsec);
            var upperBound = boundaries[1];
            if (upperBound != null) {
                return upperBound.index;
        ...
        MappedContext.prototype.getTickLocalTimeOffsetMsec = function () {
            return this.boundContext.getTickLocalTimeOffsetMsec();
        };
        return MappedContext;
    }());
    var ContextHomogenizer = (function () {
        function ContextHomogenizer() {
            this.ticks = new CscApi.OrderedHashMap();
            this.mappedContexts = {};
            this.callbackOfTickUpdated = null;
            this.callbackOfTickRemoved = null;
        }
        ContextHomogenizer.prototype.getAnyEvaluatedContext = function () {
            var pickedEvaluatedContext = null;
            var mappedContexts = this.mappedContexts;
            for (var key in mappedContexts) {
                pickedEvaluatedContext = mappedContexts[key];
                break;
            }
            return pickedEvaluatedContext;
        };
        ContextHomogenizer.prototype.getContextIdList = function () {
            return Object.keys(this.mappedContexts);
        };
        ContextHomogenizer.prototype.getBoundContext = function (contextId) {
            var mappedContext = this.mappedContexts[contextId];
            return mappedContext != null ? mappedContext.getBoundContext() : null;
        };
        ContextHomogenizer.prototype.getLowerBoundTicks = function (tickTimeInMsec) {
            var mappedContexts = this.mappedContexts;
            var ticks = [];
            for (var contextId in mappedContexts) {
                var context = mappedContexts[contextId];
                var lowerBoundIndex = context.getLowerBoundTickIndexByTime(tickTimeInMsec);
                if (lowerBoundIndex != null) {
                    var orderedTickList = context.getOrderedTickList();
                    var tick = orderedTickList[lowerBoundIndex];
                    if (tick != null) {
                        ticks.push(tick);
                    }
                }
        ...
        ContextHomogenizer.prototype.getUperBoundTicks = function (tickTimeInMsec) {
            var mappedContexts = this.mappedContexts;
            var ticks = [];
            for (var contextId in mappedContexts) {
                var context = mappedContexts[contextId];
                var upperBoundIndex = context.getUpperBoundTickIndexByTime(tickTimeInMsec);
                if (upperBoundIndex != null) {
                    var orderedTickList = context.getOrderedTickList();
                    var tick = orderedTickList[upperBoundIndex];
                    if (tick != null) {
                        ticks.push(tick);
                    }
                }
        ...
        ContextHomogenizer.prototype.bindContext = function (contextId, context) {
            var _this = this;
            var mappedContexts = this.mappedContexts;
            var mappedContext = mappedContexts[contextId];
            if (mappedContext) {
                throw 'duplicated binding context for context ID: ' + contextId;
            }
            mappedContext = new MappedContext(contextId, context, this.ticks);
            var tickUpdatedEventHandleId = context.addEventListenerOnTickUpdated(function (modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
                if (_this._onContextAddTicks(contextId, context, changedKeyList, changedValueList)) {
                    _this._allEvaluatedContextsBeDirty();
                }
                mappedContext.beDirty();
                _this.fireEventOfTickUpdated(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
            });
            var tickRemovedEventHandleId = context.addEventListenerOnTickRemoved(function (modifiedLowerestIndex, changedKeyList, changedValueList) {
                if (_this._onContextRemoveTicks(contextId, context, changedKeyList, changedValueList)) {
                    _this._allEvaluatedContextsBeDirty();
                }
                mappedContext.beDirty();
                _this.fireEventOfTickRemoved(contextId, modifiedLowerestIndex, changedKeyList, changedValueList);
            });
            if (tickUpdatedEventHandleId == null || tickRemovedEventHandleId == null) {
                this.unbindContext(contextId);
                throw 'failed to add event listeners to context.';
            }
            mappedContexts[contextId] = mappedContext;
            if (this._onContextAddTicks(contextId, context, null, null)) {
                this._allEvaluatedContextsBeDirty();
            }
        };
        ContextHomogenizer.prototype.unbindContext = function (contextId) {
            var mappedContexts = this.mappedContexts;
            var mappedContext = mappedContexts[contextId];
            if (mappedContext == null) {
                throw 'binding context is not existing, context ID: ' + contextId;
            }
            mappedContext.removeEventListeners();
            var ticks = this.ticks;
            var valueList = ticks.GetValueList();
            var numberOfValues = valueList.length;
            var keyHasRemoved = false;
            for (var i = 0; i < numberOfValues; ++i) {
                var tickDataMap = valueList[i];
                var tickData = tickDataMap[contextId];
                if (tickData == null) {
                    continue;
                }
                delete tickDataMap[contextId];
                if (Object.keys(tickDataMap).length === 0) {
                    ticks.Remove(tickData.getDatetime().getTime());
                    keyHasRemoved = true;
                }
            }
            if (keyHasRemoved) {
            ...
            delete this.mappedContexts[contextId];
            return null;
        };
        ContextHomogenizer.prototype._allEvaluatedContextsBeDirty = function () {
            var mappedContexts = this.mappedContexts;
            for (var contextId in mappedContexts) {
                var mappedContext = mappedContexts[contextId];
                mappedContext.beDirty();
        ...
        ContextHomogenizer.prototype.getEvaluatedContext = function (contextId) {
            var mappedContexts = this.mappedContexts;
            var mappedContext = mappedContexts[contextId];
            if (mappedContext == null) {
                throw 'evaluated context is not existing, context ID: ' + contextId;
            }
            return mappedContext;
        };
        ContextHomogenizer.prototype.getContextTickUpdatedCallback = function () {
            return this.callbackOfTickUpdated;
        };
        ContextHomogenizer.prototype.setContextTickUpdatedCallback = function (callback) {
            this.callbackOfTickUpdated = callback;
        };
        ContextHomogenizer.prototype.getContextTickRemovedCallback = function () {
            return this.callbackOfTickRemoved;
        };
        ContextHomogenizer.prototype.setContextTickRemovedCallback = function (callback) {
            this.callbackOfTickRemoved = callback;
        };
        ContextHomogenizer.prototype._onContextAddTicks = function (contextId, context, changedKeyList, changedValueList) {
            var orderedTickList = context.getOrderedTickList();
            var newTicks = [];
            var hasKeyRemoved = false;
            if (changedKeyList == null) {
                var numberOfTicks = orderedTickList.length;
                for (var i = 0; i < numberOfTicks; ++i) {
                    var tickData = orderedTickList[i];
                    var date = tickData.getDatetime();
                    var timestamp = date.getTime();
                    if (this._onContextAddTick(contextId, timestamp, tickData)) {
                        hasKeyRemoved = true;
                    }
                }
            }
                ...
                var ticks = this.ticks;
                var numberOfChangedKeys = changedKeyList.length;
                for (var i = 0; i < numberOfChangedKeys; ++i) {
                    var timestamp = changedKeyList[i];
                    var tickDataMap = this.ticks.Get(timestamp);
                    if (tickDataMap === undefined) {
                        tickDataMap = {};
                        ticks.Put(timestamp, tickDataMap);
                        hasKeyRemoved = true;
                    }
                    var tickData = changedValueList[i];
                    tickDataMap[contextId] = tickData;
                }
            }
            return hasKeyRemoved;
        };
        ContextHomogenizer.prototype._onContextAddTick = function (contextId, timestamp, tickData) {
            var ticks = this.ticks;
            var tickDataMap = ticks.Get(timestamp);
            if (tickDataMap === undefined) {
                tickDataMap = {};
                tickDataMap[contextId] = tickData;
                ticks.Put(timestamp, tickDataMap);
        ...
        ContextHomogenizer.prototype._onContextRemoveTicks = function (contextId, context, changedKeyList, changedValueList) {
            var orderedTickList = context.getOrderedTickList();
            var ticks = [];
            var hasKeyRemoved = false;
            if (changedKeyList == null) {
                ...
                for (var i = 0; i < numberOfTicks; ++i) {
                    ...
                    var timestamp = date.getTime();
                    if (this._onContextRemoveTick(contextId, timestamp)) {
                        hasKeyRemoved = true;
                    }
                }
            }
        ...
        ContextHomogenizer.prototype._onContextRemoveTick = function (contextId, timestamp) {
            var ticks = this.ticks;
            var tickDataMap = ticks.Get(timestamp);
            if (tickDataMap == null) {
                return false;
            ...
            delete tickDataMap[contextId];
            if (Object.keys(tickDataMap).length === 0) {
                ticks.Remove(timestamp);
                return true;
            }
            return false;
        };
        ContextHomogenizer.prototype.fireEventOfTickUpdated = function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList) {
            if (this.callbackOfTickUpdated) {
                this.callbackOfTickUpdated(contextId, modifiedLowerestIndex, changedKeyList, changedValueList, addedKeyList, addedValueList);
            }
        };
        ContextHomogenizer.prototype.fireEventOfTickRemoved = function (contextId, modifiedLowerestIndex, changedKeyList, changedValueList) {
            if (this.callbackOfTickRemoved) {
                this.callbackOfTickRemoved(contextId, modifiedLowerestIndex, changedKeyList, changedValueList);
            }
        };
        return ContextHomogenizer;
    }());
    CscImpl.ContextHomogenizer = ContextHomogenizer;
})(CscImpl || (CscImpl = {}));
var CscImpl;
(function (CscImpl) {
...
(function (CscImpl) {
    ...
    var Area = (function () {
        function Area(candlestickChart, areaHandleId, width, height) {
            ...
            this.focusLineX = null;
            this.focusLineY = null;
            ...
            this.focusElementValueDisplayMode = CscApi.FocusElementValueDisplayMode.ORDERING;
            this.focusElementValueSortedChartIdList = null;
            this.setFocusElementValueDisplayMode(this.focusElementValueDisplayMode);
            this.valueInfoVisible = true;
        }
        ...
        Area.prototype.getValueInfoVisible = function () {
            return this.valueInfoVisible;
        };
        Area.prototype.setValueInfoVisible = function (visible) {
            this.valueInfoVisible = visible;
        };
        ...
        Area.prototype.getViewEndXCoord = function () {
            return this.viewStartXCoord + this.width;
        };
        Area.prototype.setViewEndXCoord = function (viewEndXCoord) {
            var viewStartXCoord = viewEndXCoord - this.width;
            this.setViewStartXCoord(viewStartXCoord);
        };
        Area.prototype.getViewMaxStartXCoord = function () {
            ...
            var viewMaxStartXCoord = Math.floor(timeScale.getTotalWidth() - this.width + this.viewPaddingRight);
            if (viewMaxStartXCoord < 0) {
                viewMaxStartXCoord = 0;
            }
            return viewMaxStartXCoord;
        };
        Area.prototype.getViewTickWidth = function () {
            return this.viewTickWidth;
        };
        Area.prototype.setViewTickWidth = function (tickWidth) {
            var origViewTickWidth = this.viewTickWidth;
            this.viewTickWidth = tickWidth;
        };
        ...
        Area.prototype.update = function (updateTickFromIndex) {
            ...
            for (var handleId in chartContexts) {
                ...
                if (chart.isArgDirty()) {
                    ...
                    this.viewIsDirty = true;
                    switch (this.focusElementValueDisplayMode) {
                        case CscApi.FocusElementValueDisplayMode.SORT_BY_ARGUMENTS_ASC:
                        case CscApi.FocusElementValueDisplayMode.SORT_BY_ARGUMENTS_DESC:
                            this.updateFocusElementValueDisplayList();
                            break;
                    }
                }
                else if (tickDataIsDirty) {
        ...
        Area.prototype.isHitCoordFocusLineCenter = function (xInArea, yInArea, distanceThreshold) {
            var chartOrdered = this.chartOrdered;
            var numberOfCharts = chartOrdered.length;
            if (numberOfCharts < 1) {
                return false;
            }
            ...
            var x = timeScaleElement.viewXCoord - this.viewStartXCoord;
            ;
            var chartContexts = this.chartContexts;
            var chartViewContexts = this.chartContexts;
            var focusLineVisible = this._isFocusLineVisible();
            for (var i = 0; i < numberOfCharts; ++i) {
                var handleId = chartOrdered[i];
                var chartContext = chartContexts[handleId];
                var chart = chartContext.chart;
                var chartViewContext = chartViewContexts[handleId];
                var chartFocusValue = chartViewContext.focusValue;
                if (chartFocusValue != null) {
                    var y = Math.floor(chartViewContext.valueToYCoordConvertor(chartFocusValue));
        ...
        Area.prototype._isFocusLineVisible = function () {
            var candlestickChart = this.candlestickChart;
            var style = candlestickChart.getStyle();
            var isDrawing = candlestickChart.isDrawing();
            return isDrawing == false || isDrawing == style.getFocusLineVisibleWhenDrawing();
        };
        Area.prototype.render = function () {
            ...
            var chartContexts = this.chartContexts;
            var chartOrdered = this.chartOrdered;
            var numberOfCharts = this.chartOrdered.length;
            var viewYScales = this.viewYScales;
            if (viewYScales != null) {
                for (var i = 0; i < numberOfCharts; ++i) {
                    var handleId = chartOrdered[i];
                    var chartContext = chartContexts[handleId];
                    var chart_1 = chartContext.chart;
                    var viewYScale = viewYScales[handleId];
                    if (viewYScale != null) {
                        this.drawHorizontalGrids(renderer, chart_1, viewYScale);
                    }
                    chart_1.render(viewStartTickIndex, viewEndTickIndex);
                }
            }
            for (var i = 0; i < numberOfCharts; ++i) {
                var handleId = chartOrdered[i];
            ...
            for (var i = 0; i < numberOfCharts; ++i) {
                var handleId = chartOrdered[i];
                var chartContext = chartContexts[handleId];
                var chart_2 = chartContext.chart;
                var chartViewContext = chartViewContexts[handleId];
                var chartFocusValue = chartViewContext.focusValue;
                if (chartFocusValue != null) {
                    var yCoord = Math.floor(chartViewContext.valueToYCoordConvertor(chartFocusValue));
                    if (chartViewContext.yAxisEnabled) {
                        if (focusLineVisible) {
                            renderer.setLineWidth(styleFocusLineWidth);
                            renderer.setStrokeColorRgba(styleFocusLineColorRgba);
                        ...
                        var decimalDigits = chart_2.getDecimalDigits();
                        var caption = CscApi.Utility.roundDown(chartFocusValue, decimalDigits).toFixed(decimalDigits);
                        chart_2.drawYScaleValue(caption, yCoord);
                    }
                }
            }
            if (this.valueInfoVisible) {
                var focusElementValueSortedChartIdList = this.focusElementValueSortedChartIdList;
                if (focusElementIndex != null && focusElementValueSortedChartIdList != null) {
                    var numberOfValueInfo = 0;
                    var numberOfChartIds = focusElementValueSortedChartIdList.length;
                    for (var i = 0; i < numberOfCharts; ++i) {
                        var handleId = chartOrdered[i];
                        var chartContext = chartContexts[handleId];
                        var chart_3 = chartContext.chart;
                        if (false == chart_3.getValueInfoVisible()) {
                            continue;
                        }
                        var yOffset = (styleChartInfoFontSize + 4) * numberOfValueInfo;
                        renderer.translate(0, yOffset);
                        chart_3.renderValueInfo(focusElementIndex);
                        ++numberOfValueInfo;
                        renderer.translate(0, -yOffset);
                    }
                }
        ...
        Area.prototype.addChart = function (chartType) {
            ...
            this.chartOrdered.push(handleId);
            this.updateFocusElementValueDisplayList();
            return handleId;
        };
        ...
        Area.prototype.getChartOrderingIndex = function (handleId) {
            var i = this.chartOrdered.indexOf(handleId);
            return i !== -1 ? i : null;
        };
        ...
        Area.prototype.getFocusElementValueDisplayMode = function () {
            return this.focusElementValueDisplayMode;
        };
        Area.prototype.setFocusElementValueDisplayMode = function (mode) {
            this.focusElementValueDisplayMode = mode;
            this.updateFocusElementValueDisplayList();
        };
        Area.prototype.updateFocusElementValueDisplayList = function () {
            var _this = this;
            switch (this.focusElementValueDisplayMode) {
                case CscApi.FocusElementValueDisplayMode.NONE:
                    this.focusElementValueSortedChartIdList = null;
                    break;
                case CscApi.FocusElementValueDisplayMode.ORDERING:
                    this.focusElementValueSortedChartIdList = this.chartOrdered;
                    break;
                case CscApi.FocusElementValueDisplayMode.SORT_BY_ARGUMENTS_ASC:
                case CscApi.FocusElementValueDisplayMode.SORT_BY_ARGUMENTS_DESC:
                    var reversed = this.focusElementValueDisplayMode == CscApi.FocusElementValueDisplayMode.SORT_BY_ARGUMENTS_DESC;
                    var focusElementValueSortedChartIdList = this.focusElementValueSortedChartIdList = this.chartOrdered.sort(function (lhs, rhs) {
                        var chartContexts = _this.chartContexts;
                        var chartContextLhs = chartContexts[lhs];
                        var chartContextRhs = chartContexts[rhs];
                        var chartLhs = chartContextLhs.chart;
                        var chartRhs = chartContextRhs.chart;
                        if (chartLhs.getType() == chartRhs.getType()) {
                            var periodLhs = chartLhs.getArgValueByName('period');
                            var periodRhs = chartRhs.getArgValueByName('period');
                            if (periodLhs - periodRhs > 0) {
                                return 1;
                            }
                            else {
                                return -1;
                            ...
                            return chartLhs.getType() - chartRhs.getType();
                        }
                    });
                    if (reversed) {
                        focusElementValueSortedChartIdList.reverse();
                        if (focusElementValueSortedChartIdList.length > 1) {
                            focusElementValueSortedChartIdList.unshift(focusElementValueSortedChartIdList.pop());
                        }
                    }
                    break;
            }
            ...
            if (button === CscApi.MouseButton.LEFT) {
                ...
                for (var handleId in chartContexts) {
                    ...
                    if (removeDrawerList != null) {
                        var numberOfDrawers = removeDrawerList.length;
        ...
        Area.prototype.processMouseMove = function (xInArea, yInArea) {
            ...
            for (var handleId in chartContexts) {
                var chartContext = chartContexts[handleId];
                var chart = chartContext.chart;
                chart.processMouseMove(xInArea, yInArea);
            }
        };
        Area.prototype.getHoveredDrawerChartId = function (xInArea, yInArea) {
            var chartContexts = this.chartContexts;
            for (var handleId in chartContexts) {
                var chartContext = chartContexts[handleId];
                var chart = chartContext.chart;
                var drawerId = chart.getHoveredDrawerId(xInArea, yInArea);
                if (drawerId != null) {
                    return handleId;
                }
            }
        ...
        Area.prototype.focusY = function (yInArea) {
            ...
            for (var handleId in chartContexts) {
                var chartViewContext = chartViewContexts[handleId];
                var chart = chartViewContext.chart;
        ...
        Area.prototype.focusYByFocusedElement = function () {
            ...
            for (var handleId in chartContexts) {
                var chartViewContext = chartViewContexts[handleId];
                var chart = chartViewContext.chart;
                if (chartViewContext.yCoordToValueConvertor && focusElementIndex != null) {
                    var value = chartViewContext.chart.getValueOfElement(focusElementIndex);
                    chartViewContext.focusValue = value;
                }
                else {
        ...
        Area.prototype.unfocusValue = function () {
            var chartViewContexts = this.chartContexts;
            for (var handleId in chartViewContexts) {
                var chartViewContext = chartViewContexts[handleId];
                chartViewContext.focusValue = null;
            }
        };
        Area.prototype.confineViewArea = function () {
            var width = this.width;
            var timeScale = this.candlestickChart.getTimeScale();
            var viewMaxStartXCoord = this.getViewMaxStartXCoord();
            if (viewMaxStartXCoord < 0) {
                viewMaxStartXCoord = 0;
            }
            ...
            if (prevViewTickWidth != viewTickWidth) {
                ...
                if (newViewStartXCoord == null) {
                    if (this.viewZoomingAlignMode === CscApi.ViewAlignMode.LEFT) {
                        ...
                        this.viewStartXCoord = viewMaxStartXCoord;
                        var prevViewEndTickIndex = prevViewStartTickIndex != null && prevViewNumberOfTicks != null ? prevViewStartTickIndex + prevViewNumberOfTicks - 1 : null;
            ...
            else if (this.viewStartXCoord > viewMaxStartXCoord) {
                this.viewStartXCoord = viewMaxStartXCoord;
            }
            ...
            var timeScaleElements = timeScale.getTimeScaleElements();
            var numberOfTimeScaleElements = timeScaleElements.length;
            if (viewEndTickIndex > numberOfTimeScaleElements) {
                viewEndTickIndex = numberOfTimeScaleElements - 1;
            }
...
(function (CscImpl) {
    ...
    var ChartOfMtm = (function (_super) {
        ...
        ChartOfMtm.prototype.setConfig = function (config) {
            ...
            this.argMtmPeriod = Number(configMtmPeriod.value);
            this.argMtmMaPeriod = Number(configMtmMaPeriod.value);
            this.styleMtmLineWidth = Number(configMtmLineWidth.value);
            this.styleMtmLineColorRgba = configMtmLineColorRgba.value;
            this.styleMtmMaLineWidth = Number(configMtmMaLineWidth.value);
        ...
        ChartOfMtm.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                if (numberOfCounted >= mtmPeriod) {
                    var bi = periodIndexList[numberOfCounted - mtmPeriod];
                    var mtm = closePrice - orderedTickList[bi].getClose();
                    elementMtmList[i] = mtm;
                    if (numberOfCounted >= mtmPeriod + mtmMaPeriod) {
...
(function (CscImpl) {
    ...
    var ChartOfArBr = (function (_super) {
        ...
        ChartOfArBr.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleArLineWidth = Number(configArLineWidth.value);
            this.styleArLineColorRgba = configArLineColorRgba.value;
            this.styleBrLineWidth = Number(configBrLineWidth.value);
        ...
        ChartOfArBr.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                var lowPrice = tickData.getLow();
                var openPrice = tickData.getOpen();
                if (isNaN(highPrice) || isNaN(lowPrice) || isNaN(openPrice)) {
                    elementArList[i] = NaN;
                    elementBrList[i] = NaN;
                    continue;
                }
                if (false == isNaN(pi)) {
                    var prevTickData = orderedTickList[pi];
                    var prevClosePrice = prevTickData.getClose();
                    periodSumHO += highPrice - openPrice;
                    periodSumOL += openPrice - lowPrice;
                    periodSumHPC += highPrice - prevClosePrice;
                    periodSumPCL += prevClosePrice - lowPrice;
                    periodIndexList.push(i);
                    if (numberOfCounted >= period) {
                        if (numberOfCounted > period) {
                            var ppi = periodIndexList.shift();
                            var pi_1 = periodIndexList[0];
                            var pTick = orderedTickList[pi_1];
                            var ppTick = orderedTickList[ppi];
                            periodSumHO -= pTick.getHigh() - pTick.getOpen();
                            periodSumOL -= pTick.getOpen() - pTick.getLow();
                            periodSumHPC -= pTick.getHigh() - ppTick.getClose();
                            periodSumPCL -= ppTick.getClose() - pTick.getLow();
                        }
                        ...
                        elementArList[i] = elementBrList[i] = NaN;
                    }
                }
                else {
                    elementArList[i] = elementBrList[i] = NaN;
...
(function (CscImpl) {
    var DrawerOfGoldenSection = (function (_super) {
        ...
        function DrawerOfGoldenSection(chart, handleId) {
            ...
            this.pathOfLine2 = CscApi.createStrokePath();
            this.pathOfAxisLine = CscApi.createStrokePath();
            this.pathOfGoldenLine = CscApi.createStrokePath();
        }
        ...
        DrawerOfGoldenSection.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
            this.setStyleLine2ColorRgba(colorRgba);
        };
        ...
        DrawerOfGoldenSection.prototype.render = function () {
            ...
            if (viewLine2ext != null) {
                ...
                if (p1 && p2) {
                    ...
                    if (viewDivisionLine) {
                        this.drawLine(viewDivisionLine, this.styleLine2DashedLength);
                        this.pathOfGoldenLine.setPathAsLine(viewDivisionLine.getX1(), viewDivisionLine.getY1(), viewDivisionLine.getX2(), viewDivisionLine.getY2(), 5);
                    }
                    this.drawLineFromEndPoints(p1.getX(), p1.getY(), p2.getX(), p2.getY(), this.styleLine2DashedLength);
                    this.pathOfAxisLine.setPathAsLine(p1.getX(), p1.getY(), p2.getX(), p2.getY(), 5);
                }
        ...
        DrawerOfGoldenSection.prototype.isHover = function (xInArea, yInArea) {
            if (this.pathOfLine1.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else if (this.pathOfLine2.isPointInPath(xInArea, yInArea)) {
            ...
            else if (this.pathOfGoldenLine.isPointInPath(xInArea, yInArea)) {
                return true;
            }
            else if (this.pathOfAxisLine.isPointInPath(xInArea, yInArea)) {
                return true;
...
(function (CscImpl) {
    var DrawerOfChannel = (function (_super) {
        ...
        DrawerOfChannel.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
            this.setStyleLine2ColorRgba(colorRgba);
        };
        ...
        DrawerOfChannel.prototype.setStyleLine2DashedLength = function (dashedLength) {
            this.styleLine2DashedLength = dashedLength;
            this.config.params['line2DashedLength'].value = dashedLength;
        };
        ...
        DrawerOfChannel.prototype.render = function () {
            ...
            if (line2 != null) {
                ...
                var pathOfLine2 = this.pathOfLine2;
                pathOfLine2.setPathAsLine(line2.getX1(), line2.getY1(), line2.getX2(), line2.getY2(), 5);
            }
        };
        DrawerOfChannel.prototype.isHover = function (xInArea, yInArea) {
            var pathOfLine1 = this.pathOfLine1;
            var pathOfLine2 = this.pathOfLine2;
            return (pathOfLine1.isPointInPath(xInArea, yInArea) ||
                pathOfLine2.isPointInPath(xInArea, yInArea));
        };
...
(function (CscApi) {
    var OrderedHashMap = (function () {
        ...
        OrderedHashMap.prototype.getCloned = function () {
            var newOrderedHashMap = new OrderedHashMap();
            var map = this._map;
            var newMap = newOrderedHashMap._map;
            for (var key in map) {
                var value = map[key];
                newMap[key] = value;
            }
            newOrderedHashMap._orderedKey = this._orderedKey.slice(0);
            return newOrderedHashMap;
        };
        ...
        OrderedHashMap.prototype.GetOrderedKeys = function () {
            return this._orderedKey.slice(0);
        };
        OrderedHashMap.prototype.RefOrderedKeys = function () {
            return this._orderedKey;
        };
        OrderedHashMap.prototype.GetValueList = function () {
            return this.GetOrderedValueList();
        };
...
(function (CscImpl) {
    ...
    var ChartOfBiasAB = (function (_super) {
        ...
        ChartOfBiasAB.prototype.setConfig = function (config) {
            ...
            this.argShortPeriod = Number(configShortPeriod.value);
            this.argLongPeriod = Number(configLongPeriod.value);
            this.styleBiasLineWidth = Number(configBiasLineWidth.value);
...
(function (CscImpl) {
    ...
    var ChartOfVr = (function (_super) {
        ...
        ChartOfVr.prototype.setConfig = function (config) {
            ...
            this.argVrPeriod = Number(configVrPeriod.value);
            this.argVrMaPeriod = Number(configVrMaPeriod.value);
            this.styleVrLineWidth = Number(configVrLineWidth.value);
            this.styleVrLineColorRgba = configVrLineColorRgba.value;
            this.styleVrMaLineWidth = Number(configVrMaLineWidth.value);
...
(function (CscApi) {
    ...
    var Utility = (function () {
        ...
        Utility.roundDown = function (value, decimalDigits) {
            var tmpPow = Math.pow(10, decimalDigits);
            return Math.floor(value * tmpPow) / tmpPow;
        };
        Utility.roundUp = function (value, decimalDigits) {
            var tmpPow = Math.pow(10, decimalDigits);
            return Math.ceil(value * tmpPow) / tmpPow;
        };
        ...
        Utility.fillArray = function (arr, numberOfElements, value) {
            for (var i = 0; i < numberOfElements; ++i) {
                arr[i] = value;
            }
        };
        Utility.resizeArray = function (original, resizeNumberOfElements) {
            ...
            if (original == null) {
                var result = Array(resizeNumberOfElements);
                return result;
            }
            original.length = resizeNumberOfElements;
            return original;
        };
        Utility.resizeUint8Array = function (original, resizeNumberOfElements, defaultValue) {
            if (resizeNumberOfElements <= 0) {
                resizeNumberOfElements = 0;
            }
            if (original == null) {
                var result_1 = new Uint8Array(resizeNumberOfElements);
                if (defaultValue != null) {
                    if (result_1.fill) {
                        result_1.fill(defaultValue);
                    }
                    else {
                        Utility.fillArray(result_1, resizeNumberOfElements, defaultValue);
                    }
                }
                return result_1;
            }
                ...
                if (defaultValue != null) {
                    if (result.fill) {
                        ...
                        Utility.fillArray(result, resizeNumberOfElements, defaultValue);
                    }
                }
                return result;
            }
        ...
        Utility.resizeFloat32Array = function (original, resizeNumberOfElements, defaultValue) {
            if (resizeNumberOfElements <= 0) {
                resizeNumberOfElements = 0;
            }
            if (original == null) {
                var result_2 = new Float32Array(resizeNumberOfElements);
                if (defaultValue != null) {
                    if (result_2.fill) {
                        result_2.fill(defaultValue);
                    }
                    else {
                        Utility.fillArray(result_2, resizeNumberOfElements, defaultValue);
                    }
                }
                return result_2;
            }
...
(function (CscImpl) {
    ...
    var ChartOfRsiSmooth = (function (_super) {
        ...
        ChartOfRsiSmooth.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleRsiSmoothLineWidth = Number(configRsiSmoothLineWidth.value);
        ...
        ChartOfRsiSmooth.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                var openPrice = tickData.getOpen();
                if (isNaN(closePrice) || isNaN(openPrice)) {
                    elementRsiSmoothList[i] = elementRsiAvgRisingList[i] = elementRsiAvgFallingList[i] = NaN;
                    continue;
                }
                if (false == isNaN(pi)) {
                    ...
                    var p = numberOfCounted < period ? numberOfCounted + 1 : period;
                    var prevAvgRising = elementRsiAvgRisingList[pi];
                    var prevAvgFalling = elementRsiAvgFallingList[pi];
                    var avgRising = elementRsiAvgRisingList[i] = prevAvgRising + (todayRising - prevAvgRising) / p;
                    var avgFalling = elementRsiAvgFallingList[i] = prevAvgFalling + (todayFalling - prevAvgFalling) / p;
                    elementRsiSmoothList[i] = 100 * avgRising / (avgRising + avgFalling);
                }
                else {
                    elementRsiSmoothList[i] = NaN;
                    elementRsiAvgRisingList[i] = elementRsiAvgFallingList[i] = 0;
                }
                ++numberOfCounted;
                pi = i;
            }
        ...
        ChartOfRsiSmooth.prototype.renderValueInfo = function (focusElementIndex) {
            ...
            if (focusElementIndex != null) {
                ...
                if (rsiSmooth != null && false === isNaN(rsiSmooth))
    ...
    var ChartOfBias = (function (_super) {
        ...
        ChartOfBias.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                if (numberOfCounted >= period) {
                    var ema = sum / period;
                    elementBiasList[i] = (closePrice - ema) / ema;
                    var deductedClosePrice = periodSumPriceList.shift();
                    sum -= deductedClosePrice;
                }
                else {
                    elementBiasList[i] = NaN;
                }
...
(function (CscFacade) {
    var CandlestickChartStyleFacade = (function (_super) {
        ...
        CandlestickChartStyleFacade.prototype.adjustGlobalFontSize = function (minFontSize, maxFontSize, autoAdjustStyles) {
            ...
            return this.processStyleChanged();
        };
...
(function (CscImpl) {
    ...
    var ChartOfDmi = (function (_super) {
        ...
        ChartOfDmi.prototype.setConfig = function (config) {
            ...
            this.argPeriod = Number(configPeriod.value);
            this.styleDmipLineWidth = Number(configDmipLineWidth.value);
            this.styleDmipLineColorRgba = configDmipLineColorRgba.value;
            this.styleDminLineWidth = Number(configDminLineWidth.value);
            this.styleDminLineColorRgba = configDminLineColorRgba.value;
            this.styleAdxLineWidth = Number(configAdxLineWidth.value);
            this.styleAdxLineColorRgba = configAdxLineColorRgba.value;
            this.styleAdxrLineWidth = Number(configAdxrLineWidth.value);
        ...
        ChartOfDmi.prototype.updateElements = function (updateTickFromIndex) {
            ...
            for (var i = 0; i < numberOfOrderedTickList; ++i) {
                ...
                var lowPrice = tickData.getLow();
                if (isNaN(highPrice) || isNaN(lowPrice)) {
                    elementDxList[i] = elementDmpList[i] = elementDmnList[i] = 0;
                ...
                if (false == isNaN(pi)) {
                    var prevTickData = orderedTickList[pi];
                    var prevClose = prevTickData.getClose();
                    var prevHigh = prevTickData.getHigh();
                    var prevLow = prevTickData.getLow();
                    elementDxList[i] = 0;
                    elementAdxList[i] = 0;
                    var tr = elementTrList[i] = Math.max(highPrice, prevClose) - Math.min(lowPrice, prevClose);
                    var dmp = Math.max(0, highPrice - prevHigh);
                    var dmn = Math.max(0, prevLow - lowPrice);
                    dmp = (dmp > dmn) ? dmp : 0;
                    dmn = (dmn > dmp) ? dmn : 0;
                    ...
                    if (numberOfCounted >= period) {
                        var bi = void 0;
                        if (periodIndexList.length >= period) {
                            bi = periodIndexList.shift();
                        }
                        if (bi != null) {
                    ...
                    elementTrList[i] = highPrice - lowPrice;
                    elementDxList[i] = elementDmpList[i] = elementDmnList[i] = 0;
                    elementDipList[i] = elementDinList[i] = elementAdxList[i] = elementAdxrList[i] = NaN;
                }
                periodIndexList.push(i);
...
var CscApi;
(function (CscApi) {
    var StrokePathCompatible = (function () {
        function StrokePathCompatible() {
            var canvas = this._canvas = document.createElement('canvas');
            canvas.width = canvas.height = 1;
            canvas.style.display = 'none';
            var ctx = this._ctx = canvas.getContext('2d', { alpha: false });
            ctx.save();
            ctx.strokeStyle = ctx.fillStyle = 'transparent';
            this._pathType = null;
            this._additionPaths = null;
        }
        StrokePathCompatible.prototype.setTransform = function (r1c1, r2c1, r1c2, r2c2, r1c3, r2c3) {
            this._ctx.setTransform(r1c1, r2c1, r1c2, r2c2, r1c3, r2c3);
        };
        StrokePathCompatible.prototype.transform = function (r1c1, r2c1, r1c2, r2c2, r1c3, r2c3) {
            this._ctx.transform(r1c1, r2c1, r1c2, r2c2, r1c3, r2c3);
        };
        StrokePathCompatible.prototype.scale = function (sx, sy) {
            this._ctx.scale(sx, sy);
        };
        StrokePathCompatible.prototype.rotate = function (angle) {
            this._ctx.rotate(angle);
        };
        StrokePathCompatible.prototype.translate = function (x, y) {
            this._ctx.translate(x, y);
        };
        StrokePathCompatible.prototype.resetPath = function () {
            var ctx = this._ctx;
            ctx.restore();
            ctx.save();
            return this;
        };
        StrokePathCompatible.prototype.setPathAsLine = function (x1, y1, x2, y2, lineWidth) {
            if (this._pathType != CscApi.PathType.LINE) {
                this._pathType = CscApi.PathType.LINE;
                this._additionPaths = null;
            }
            var dx = x2 - x1;
            var dy = y2 - y1;
            ...
            var rotation = lineRadianAngle;
            var rectX = 0;
            var rectY = -lineWidth * 0.5;
            var ctx = this._ctx;
            ctx.save();
            ctx.beginPath();
            ctx.translate(x1, y1);
            ctx.rotate(rotation);
            ctx.rect(rectX, rectY, lineLength, lineWidth);
            ctx.translate(-x1, -y1);
            ctx.rotate(-rotation);
            ctx.closePath();
            ctx.restore();
        };
        StrokePathCompatible.prototype.setPathAsArc = function (cx, cy, radius, startAngle, endAngle, arcLineWidth) {
            if (this._pathType != CscApi.PathType.ARC) {
                this._pathType = CscApi.PathType.ARC;
                this._additionPaths = null;
            }
            var ctx = this._ctx;
            var halfArcLineWidth = arcLineWidth * 0.5;
            ctx.save();
            ctx.beginPath();
            ctx.arc(cx, cy, Math.max(0, radius - halfArcLineWidth), startAngle, endAngle, false);
            ctx.arc(cx, cy, Math.max(0, radius + halfArcLineWidth), endAngle, startAngle, true);
            ctx.closePath();
            ctx.restore();
        };
        StrokePathCompatible.prototype.setPathAsFan = function (cx, cy, radius, startAngle, endAngle, fanLineWidth) {
            if (this._pathType != CscApi.PathType.FAN) {
                this._pathType = CscApi.PathType.FAN;
                this._additionPaths = [new CscApi.StrokePathCompatible(), new CscApi.StrokePathCompatible(), new CscApi.StrokePathCompatible()];
            }
            var arc = this._additionPaths[0];
            var lineA = this._additionPaths[1];
            var lineB = this._additionPaths[2];
            arc.setPathAsArc(cx, cy, radius, startAngle, endAngle, fanLineWidth);
            lineA.setPathAsLine(cx, cy, cx + Math.floor(Math.cos(startAngle) * radius), cy + Math.floor(Math.sin(startAngle) * radius), fanLineWidth);
            lineB.setPathAsLine(cx, cy, cx + Math.floor(Math.cos(endAngle) * radius), cy + Math.floor(Math.sin(endAngle) * radius), fanLineWidth);
        };
        StrokePathCompatible.prototype.isPointInPath = function (x, y) {
            if (this._ctx.isPointInPath(x, y)) {
                return true;
            }
            var additionPaths = this._additionPaths;
            if (additionPaths != null) {
                var numberOfAdditionPaths = additionPaths.length;
                for (var i = 0; i < numberOfAdditionPaths; ++i) {
                    if (additionPaths[i].isPointInPath(x, y)) {
                        return true;
                    }
                }
            }
        ...
        return StrokePathCompatible;
    }());
    CscApi.StrokePathCompatible = StrokePathCompatible;
})(CscApi || (CscApi = {}));
var CscImpl;
(function (CscImpl) {
...
(function (CscImpl) {
    var DrawerOfHorizontalLine = (function (_super) {
        ...
        DrawerOfHorizontalLine.prototype.setColor = function (colorRgba) {
            this.setStyleLine1ColorRgba(colorRgba);
        };
            ...
            switch (currentStep) {
                ...
                case 1:
                    ...
                    if (drawnStep.value != null) {
                        ...
                        var pathOfLine1 = this.pathOfLine1;
                        pathOfLine1.setPathAsLine(0, y, this.chart.getWidth(), y, 5);
                    }
                    break;
            }
        };
        DrawerOfHorizontalLine.prototype.isHover = function (xInArea, yInArea) {
            var pathOfLine1 = this.pathOfLine1;
            return pathOfLine1.isPointInPath(xInArea, yInArea);
        };
...
var CscApi;
(function (CscApi) {
    var StrokePathImpl = (function () {
        function StrokePathImpl() {
            var canvas = this._canvas = document.createElement('canvas');
            canvas.width = canvas.height = 1;
            canvas.style.display = 'none';
            var ctx = this._ctx = canvas.getContext('2d', { alpha: false });
        ...
        StrokePathImpl.prototype.setTransform = function (r1c1, r2c1, r1c2, r2c2, r1c3, r2c3) {
            this._ctx.setTransform(r1c1, r2c1, r1c2, r2c2, r1c3, r2c3);
        };
        StrokePathImpl.prototype.transform = function (r1c1, r2c1, r1c2, r2c2, r1c3, r2c3) {
            this._ctx.transform(r1c1, r2c1, r1c2, r2c2, r1c3, r2c3);
        };
        StrokePathImpl.prototype.scale = function (sx, sy) {
            this._ctx.scale(sx, sy);
        };
        StrokePathImpl.prototype.rotate = function (angle) {
            this._ctx.rotate(angle);
        };
        StrokePathImpl.prototype.translate = function (x, y) {
            this._ctx.translate(x, y);
        };
        StrokePathImpl.prototype.resetPath = function () {
            var ctx = this._ctx;
            ctx.restore();
            ctx.save();
            return this;
        };
        StrokePathImpl.prototype.setPathAsLine = function (x1, y1, x2, y2, lineWidth) {
            var ctx = this._ctx;
        ...
        StrokePathImpl.prototype.setPathAsArc = function (cx, cy, radius, startAngle, endAngle, arcLineWidth) {
            var ctx = this._ctx;
            var halfArcLineWidth = arcLineWidth * 0.5;
        ...
        StrokePathImpl.prototype.setPathAsFan = function (cx, cy, radius, startAngle, endAngle, fanLineWidth) {
            var ctx = this._ctx;
            var halfArcLineWidth = fanLineWidth * 0.5;
            ctx.lineWidth = fanLineWidth;
            ctx.save();
            ctx.beginPath();
            ctx.arc(cx, cy, Math.max(0, radius - halfArcLineWidth), startAngle, endAngle, false);
            ctx.moveTo(cx, cy);
            ctx.lineTo(cx + Math.floor(Math.cos(startAngle) * radius), cy + Math.floor(Math.sin(startAngle) * radius));
            ctx.moveTo(cx, cy);
            ctx.lineTo(cx + Math.floor(Math.cos(endAngle) * radius), cy + Math.floor(Math.sin(endAngle) * radius));
            ctx.closePath();
            ctx.restore();
        };
        StrokePathImpl.prototype.isPointInPath = function (x, y) {
            return this._ctx.isPointInStroke(x, y);
        };
        return StrokePathImpl;
    }());
    CscApi.StrokePathImpl = StrokePathImpl;
})(CscApi || (CscApi = {}));

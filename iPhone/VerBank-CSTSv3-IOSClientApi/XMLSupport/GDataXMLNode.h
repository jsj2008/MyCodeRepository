...
// These node, element,   document classes implement a subset of the methods
...
// impact), we rely on weak references,   it is up to the code that
...
@protected
  ...
  //   "{http://uri}:name"
  //
  // We will fix up the node's namespace   name (  those of any children)

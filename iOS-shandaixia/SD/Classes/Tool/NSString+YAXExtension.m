...
+ (NSString *)getUUID {
    ...
    NSString *oldUUID = [[NSUserDefaults standardUserDefaults] objectForKey:@"mUUID"];
    if (oldUUID == nil) {
        CFUUIDRef theUUID = CFUUIDCreate(NULL);
        CFStringRef string = CFUUIDCreateString(NULL, theUUID);
        CFRelease(theUUID);
        [[NSUserDefaults standardUserDefaults] setObject:(__bridge_transfer NSString *)string forKey:@"mUUID"];

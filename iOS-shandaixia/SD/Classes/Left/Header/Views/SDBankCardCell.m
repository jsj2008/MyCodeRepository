...
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    ...
    static NSString *ID = @"SDBankCardCell";
    SDBankCardCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        
        
        cell = [[SDBankCardCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        backView.layer.cornerRadius = 10 * SCALE;
        backView.clipsToBounds = YES;
        
        UIImageView *headBackView = [[UIImageView alloc] initWithImage:[UIImage imageWithBgColor:[UIColor clearColor]]];;

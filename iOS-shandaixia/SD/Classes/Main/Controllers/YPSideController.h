...
/** 左侧菜单控制器 */
@property (nonatomic, strong) YPLeftMenuController *leftMenuViewController;
...
- (instancetype)initWithContentViewController:(UIViewController *)contentViewController
             leftMenuViewController:(YPLeftMenuController *)leftMenuViewController;

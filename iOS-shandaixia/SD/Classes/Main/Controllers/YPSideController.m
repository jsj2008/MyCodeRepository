...
#pragma mark - Public
- (instancetype)initWithContentViewController:(UIViewController *)contentViewController leftMenuViewController:(YPLeftMenuController *)leftMenuViewController
{
    self = [self init];
    if (!self) return nil;
...
//    } else if (iPHone6Plus) {
//
//        _hideOffset = 228 * SCALE;
//
//    }
    
    _hideOffset = SCREENWIDTH/2 - 148 * SCALE;

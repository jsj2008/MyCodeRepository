...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    } else if ([self.imagesArr[indexPath.item] isKindOfClass:[NSURL class]]) {
        
        // 这里需要你自己设置占位图 (这里替换图片的时候默认使用溶解动画)
        [imageView sd_setImageWithURL:self.imagesArr[indexPath.item] placeholderImage:[UIImage imageNamed:@"ads"]];
    }
...
- (void)setImagesCount:(NSInteger)imagesCount {
    ...
    self.page.tintColor = SDWhiteColor;
    self.page.currentPageIndicatorTintColor = SDWhiteColor;

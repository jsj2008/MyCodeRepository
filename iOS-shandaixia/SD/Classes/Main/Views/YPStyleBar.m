...
//    self.itemContainerView.frame = CGRectMake(0, 20, self.yp_right, 44);
    self.itemContainerView.y = 20;
    
    self.itemContainerView.width = self.yp_right;
    
    self.itemContainerView.height = 44;
    
    self.itemContainerView.x = SCREENWIDTH/2 - 50 - YPStyleBarLeftOrRightBtnWH;
    ...
    self.leftBtn.backgroundColor = self.rightBtn.backgroundColor = [UIColor clearColor];
...
//    self.bottomLine.frame = CGRectMake(0, self.yp_bottom - 0.5 , self.yp_width, 1 * SCALE);
    
    self.bottomLine.backgroundColor = FDColor(231, 231, 231);
...
//    UIImageView *backImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"home_shade"]];
...
//    [self addSubview:backImageView];
    ...
    // 初始化文字普通状态时的颜色
    _textColor_normal = [UIColor whiteColor];
    // 初始化文字选中状态时的颜色
    _textColor_selected = [UIColor whiteColor];

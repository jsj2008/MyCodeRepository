//
//  SDAnnouncementDetailController.m
//  SD
//
...
@interface SDAnnouncementDetailController ()
...
@implementation SDAnnouncementDetailController
...
//    [self createNavBarWithTitle:@"公告详情" w];
    [self createNavBarWithTitle:@"公告详情"
                  withRightTile:@"更多"
                      andAction:^{
                          NSLog(@"more");
                      }];

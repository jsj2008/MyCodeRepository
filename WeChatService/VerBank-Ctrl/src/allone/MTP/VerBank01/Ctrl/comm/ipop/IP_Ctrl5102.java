 ...
 * @Title: IP_Ctrl5102.java 
 * @Package allone.MTP.VerBank01.Ctrl.comm.ipop 
 * @Description: 申請憑證　(ApplyCert) 
 * @author wyb wang.yubo@allone.cn 
 * @date 2015年10月15日 下午3:18:21 
 * @Copyright: 2015 www.allone.cn Inc. All rights reserved. 
 * @version V3.0.0   
 */
public class IP_Ctrl5102 extends CtrlServerIPFather {
 
	private static final long serialVersionUID = -2613299899220198412L;

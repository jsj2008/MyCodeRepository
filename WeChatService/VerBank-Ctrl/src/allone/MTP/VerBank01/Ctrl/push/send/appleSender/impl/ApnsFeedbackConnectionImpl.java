...
import static allone.MTP.VerBank01.Ctrl.push.send.appleSender.model.ApnsConstants.FEEDBACK_HOST_DEVELOPMENT_ENV;
import static allone.MTP.VerBank01.Ctrl.push.send.appleSender.model.ApnsConstants.FEEDBACK_HOST_PRODUCTION_ENV;
import static allone.MTP.VerBank01.Ctrl.push.send.appleSender.model.ApnsConstants.FEEDBACK_PORT_DEVELOPMENT_ENV;
import static allone.MTP.VerBank01.Ctrl.push.send.appleSender.model.ApnsConstants.FEEDBACK_PORT_PRODUCTION_ENV;
		...
		try {
			...
			if (socket != null) {
				try {
					...
					LogProxy.ErrPrintln(e2.getMessage());
					e2.printStackTrace();
				}
			}
		}

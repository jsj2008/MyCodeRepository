...
public class C3_OP_QDB1003 extends jedi.ex02.CSTS3.comm.ipop.C3_OPFather {

	public static final String jsonId = "OP_QDB1003";

	public static final String list = "1";

	public C3_OP_QDB1003(jedi.ex02.CSTS3.comm.ipop.C3_IPFather ip){
		super(ip);
		setEntry("jsonId", jsonId);
	}

	public void parseFromSysData(OP_QDB1003 data) throws Exception {
	...
	public C3_HistoricData[] getList() {
		try {
			C3_HistoricData[] data=getEntryObjectVec(C3_OP_QDB1003.list,new C3_HistoricData[0]);
			return data;
	...
	public void setList(C3_HistoricData[] list) {
		setEntry(C3_OP_QDB1003.list, list);
	}

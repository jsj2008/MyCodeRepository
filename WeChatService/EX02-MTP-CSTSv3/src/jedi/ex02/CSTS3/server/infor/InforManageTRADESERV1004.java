...
import jedi.ex02.CSTS3.comm.info.C3_Info_TRADESERV1004;
...
public class InforManageTRADESERV1004 extends InforManageFather {

	@Override
	protected C3_InfoFather formatInfor(InforFather infor) {
		C3_Info_TRADESERV1004 info=new C3_Info_TRADESERV1004((TradeServInfoFather) infor);
		try {
			info.parseFromSysData((Info_TRADESERV1004) infor);
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
